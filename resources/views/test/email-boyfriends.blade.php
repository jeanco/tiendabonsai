...
<body>
  <article style="color: black; display: block; font-size: 18px; margin: 0 auto; max-width: 650px; text-align: " class="email">
      ...
      <tbody style="border-top: 1px dashed #828286; border-bottom: 1px dashed #828286" class="table__t">
        <tr>
          <td style="padding-top: 1rem" class="pt3">
            <b>Nombres y apellidos:</b> Luis Charres</td>
          <td style="padding-top: 1rem" class="pt3">
            <b>Nombres y apellidos:</b> Jennifer Lawrence</td>
        </tr>
        ...
        <tr>
          <td style="padding-top: 1rem" class="pt3">
            <b>Celular:</b> 96984650</td>
          <td style="padding-top: 1rem" class="pt3">
            <b>Celular</b> 9690904059</td>
        </tr>
        <tr>
          <td style="padding-top: 1rem" class="pt3">
            <b>Correo Electónico:</b> luis.charres.06@gmail.com</td>
          <td style="padding-top: 1rem" class="pt3">
            <b>Correo Electónico:</b> iluis.06@gmail.com</td>
        </tr>
        <tr>
          <td style="padding-top: 1rem" class="pt3">
            <b>Fecha de nacimiento:</b> luis.charres.06@gmail.com</td>
          <td style="padding-top: 1rem" class="pt3">
            <b>Fecha de nacimiento:</b> iluis.06@gmail.com</td>
        </tr>
        <tr>
          <td style="padding-top: 1rem" class="pt3">
            <b>Dirección:</b> Conor sur</td>
          <td style="padding-top: 1rem" class="pt3">
            <b>Dirección:</b> Ciudad perdida</td>
        </tr>
      </tbody>
    </table>
    ...
    <p style="font-size: 2em; font-weight: 300;color: #f00;margin-top: 0;margin-bottom: 1rem" class="email__title primary mt0 mb3">
      <strong>Iglesia San Pedro de los Malandros</strong>
    </p>
