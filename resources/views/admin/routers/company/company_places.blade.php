<div class="col-md-12">
  <div class="tab-wrapper row u-px3 u-py5">
    <div class="col-md-12 u-mb4">
      ...
      <button type="button" class="btn btn-primary" id="place__add" data-target="#new-place" data-toggle="modal">
      <i class="glyphicon glyphicon-plus u-mr2"></i>Nueva Sede
      </button>
      @endif
    </div>
