<div class="col-md-12">
  <div class="tab-wrapper row u-px3 u-py5">
    <div class="col-md-12 u-mb4">
      <button type="button" class="btn btn-primary" id="testimony__add" data-target="#add-testimony" data-toggle="modal">
        <i class="glyphicon glyphicon-plus u-mr2"></i>Nuevo Testimonio
      </button>
    </div>

    {{-- Modificar la lista de cuentas --}}
    <ul class="col-md-12" id="testimonies-grid">
      {{-- @for($i=0; $i < 8 ; $i++)
