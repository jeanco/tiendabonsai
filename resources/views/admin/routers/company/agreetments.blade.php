<div class="col-md-12">
  <div class="tab-wrapper row u-px3 u-py5">
    <div class="col-md-12 u-mb4">
      <button type="button" class="btn btn-primary" id="agreetment_add" data-target="#add-agreetments" data-toggle="modal">
        <i class="glyphicon glyphicon-plus u-mr2"></i>Nuevo Aliado
      </button>
    </div>

    {{-- Modificar la lista de cuentas --}}
    <ul class="col-md-12" id="agreetments_grid">
      {{-- @for($i=0; $i < 8 ; $i++)
