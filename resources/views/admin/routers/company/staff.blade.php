<div class="col-md-12">
  <div class="tab-wrapper row u-px3 u-py5">
    <div class="col-md-12 u-mb4">
      <button type="button" class="btn btn-primary" id="staff__add" data-target="#add-staff" data-toggle="modal">
        <i class="glyphicon glyphicon-plus u-mr2"></i>Nuevo Personal
      </button>
    </div>

    <ul class="col-md-12" id="staff-grid">
      {{-- @for($i=0; $i < 8 ; $i++)
