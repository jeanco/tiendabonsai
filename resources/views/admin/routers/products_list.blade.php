...
<header class="c-sub-header u-bg-white">
  <div class="u-flex u-flex-1" id="product_filter">
    <div class="form-group u-mb0" style="padding: 10px 5px 10px 10px;">
    ...
    <div class="form-group u-mb0" style="padding: 10px 5px;">
      <select class="form-control" id="product_subcategories">
        <option value="">Todas las subcategorías</option>
      </select>
    </div>
    <input type="hidden" value="1" id="product_datatable">
    <input type="hidden" value={{in_array('nueva-categoria', $permissions_array)}}>
    <div class="form-group u-mb0" style="padding: 10px 5px;">
      <a href="#" class="btn btn-primary" id="product__export">Exportar</a>
    </div>
    ...
    <div class="form-group u-mb0" style="padding: 10px 5px;">
        <select class="form-control" id="promotion_available_">
            <option value="">Estado de la promoción</option>
            <option value="1">Activo</option>
            <option value="0">No Activo</option>
        </select>
    </div>
    <div class="form-group u-mb0" style="padding: 10px 5px;">
        <select class="form-control" id="promotion_outstanding_">
            <option value="">Promoción destacada</option>
    ...
    <div style="padding: 10px 5px;">
      <a href="/admin/productos-grilla"><button  title="Ver en formato grillas" class=" btn-info glyphicon glyphicon-th" style="width: 45px; height: 32px;"> </button></a>
      <a href="/admin/productos-grilla"><span style="padding: 15px; font-weight: bold;">Gestión de Categoría</span></a>
    </div>

    <div style="padding: 10px 5px;">
      <button class="product__add btn btn-success">Nuevo producto</button>
    </div>
...
<div class="row u-mx4 u-mb4 u-mt5 u-bg-white" id="products_wrap">
  ...
  <div class="col-md-12 mb-1" style="">
    ...
    <div class="col-lg-9 col-xl-9" style="display:none;">
  ...
  <section class="col-md-12" id="products_grid">
    ...
    <div class="u-flex">
      ...
      <div style="padding: 10px;">
        <button class="btn btn-success" id="product__import">Importar</button>
      </div>
      <div style="padding: 10px;">
        <form action="/admin/getting-images" method="POST">
          {{ csrf_field() }}
          <button type="submit" class="btn btn-success">Importar Imágenes</button>
        </form>
      </div>
    </div>
...
@include('admin.modals.item.price_item')
 @include('admin.modals.item.transfer_price')
