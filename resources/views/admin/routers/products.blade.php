...
<header class="c-sub-header u-bg-white">
  <div class="u-flex u-flex-1">
    ...
    <div class="c-categoriy__wrapper">
      ...
      <button type="button" class="c-category__dropdown toggle-sub-menu">Categorías<span class="caret"></span></button>
    ...
    <a href="/admin/productos-lista"><button  title="Ver en formato Lista de productos" class=" btn-info glyphicon glyphicon-th-list" style="width: 45px; height: 59px;"> </button></a>
      ...
      <div class="form-group">
        ...
        <div class="form-group" style="margin-top:10px;">
          ...
          <div class="input-group">
            ...
            <span class=" input-group-addon u-mb4 u-bg-success"> $ </span>
          </div>
...
<div class="row u-mx4 u-mb4 u-mt5 u-bg-white" id="products_wrap">
  ...
  <div class="col-lg-4 col-md-6">
    <button onclick="productAdd(this)" class="c-item">
