...
<head>
    ...
    <meta property="og:image" content="{{ $company_main->logotype_white }}" />
    ...
    <!-- Favicons-->
    <link rel="shortcut icon" href="{{ $company_main->logotype_white }}" type="image/x-icon">
...
<body style="font-family: 'prata', sans-serif;">

	<div id="page">

        
    @if(Session::get('menu_pages'))
    @include('template_1.layouts.sections.header_pages')
    @else
    ...
    <script>
         ...
         $("#idioma_id").change(function() {
                value =$("#idioma_id").val();
                sessionStorage.setItem("idioma_id", value);

                if (value == 2) {
                    window.location.replace(`https://clubbonsai-com.translate.goog/?_x_tr_sl=es&_x_tr_tl=en&_x_tr_hl=es&_x_tr_pto=wapp`);
                }else{
                    sessionStorage.setItem("idioma_id", 1);
                    window.location.replace(`https://clubbonsai.com`);
                }
        ...
        // });
         ...
         $(document).ready(function(){
                ...
                idioma_id = 1;
            if (sessionStorage.getItem("idioma_id")) {
                var idioma_id = sessionStorage.getItem("idioma_id");
            }
            
          $("#idioma_id").val(idioma_id);  
        /* Preloader */
