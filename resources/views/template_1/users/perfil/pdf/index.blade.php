      ...
      <table width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="pdf-table">{{ number_format($product['price'], 2, '.', '') }}</td>
            <td class="pdf-table">{{ number_format($product['discount'], 2, '.', '') }}</td>
            <td class="pdf-table" style="color: #00549d; font-weight: 700;">{{ number_format($product['sub_total'], 2, '.', '') }}</td>
          </tr>
          @endforeach
<!--           <tr>
         ...
         <tfoot>
          ...
          <tr>
            ...
            <td class="">S/ {{  $t['global_discount'] - $t['total'] }}</td>
          </tr>
