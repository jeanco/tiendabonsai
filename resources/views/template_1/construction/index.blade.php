    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
               ...
               <img src="{{ $company_main->logotype }}" alt="Afipe ERP" width="300px">
            </div>

            

                <!-- <div class="subtitle m-b-md">
                    Agregando valor tecnol�gico
                </div> -->
                 <br>
               ...
               <div class="row text-center">
               <img src="https://dl.dropboxusercontent.com/s/1fle4hiyq6496s8/pagina%20en%20construccion.png?dl=0" alt="Afipe ERP" width="75%">
            </div>

            <div class="links" style="color: #ffffff">
                 <br> <br> <br>
                 
                    <a  href="#" style="color: {{ $company_main->color_primary }}">Estamos Trabajando Para Brindarte Un Mejor Servicio</a>
