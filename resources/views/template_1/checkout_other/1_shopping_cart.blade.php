	...
	<main class="bg_gray">
		...
		<table class="table table-striped cart-list">
							...
							<tbody id="cart_tbody">
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_1/img/products/product_placeholder_square_small.jpg" data-src="/template_1/img/products/shoes/1.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_1/img/products/product_placeholder_square_small.jpg" data-src="/template_1/img/products/shoes/2.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_1/img/products/product_placeholder_square_small.jpg" data-src="/template_1/img/products/shoes/3.jpg" class="lazy" alt="Image">
										</div>
		...
		<div class="box_cart">
			...
			<div class="tooltip" id="tooltip">
					<div class="thumb">
						<img src="/template_1/img/paso_checkout.png" alt="">
					</div>
					<div class="info">
...
<!-- SPECIFIC CSS -->
    <link href="/template_1/css/cart.css" rel="stylesheet">
...
<script src="/template_1/js/checkout.js"></script>
