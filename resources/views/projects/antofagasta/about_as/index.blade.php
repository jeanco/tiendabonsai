...
<div class="awesome-feature" style="padding: 0px;">
  <div class="row">
    <div class="col-md-6 text-center" style="background: #004395; padding: 50px;">
      <div class="container">
          <div class="section-title text-center">
    ...
    <div class="col-md-6 text-center" style="background: #303030; padding: 50px;">
      <div class="container">
          <div class="section-title text-center">
            ...
            <div class="col-lg-7 col-12">
                <div class="download-apps-desc wow fadeInDown" data-wow-delay="0.1s">
                    <div class="download-apps-title">
                        <h3 class="title-1">REGISTRATE</h3>
                        <h3 class="title-2">y publica tu inmobiliario</h3>
                    </div>
