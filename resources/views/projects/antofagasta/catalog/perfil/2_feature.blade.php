<div class="col-lg-4 col-md-8 col-12 order-lg-1">
    <div class="sidebar right-side">
        ...
        <div class="find-home-item mb-3">
            <input type="text" name="min-area" placeholder="Buscar" style="border-radius: 10px; padding-left: 15px;" id="product-perfil_text-to-search">
        </div>
        <div class="mb-4">
        ...
        <div class="contact-form text-center">
            ...
            <div class="mb-4" style="font-size: 16px;">Antofagasta a su servicio</div>
