        ...
        <div class="block-content">
          <form>
            ...
            <div class="mb-2">
              ...
              <label class="checkbox" for="atributo{{$key}}{{$i}}0" style="font-weight: 400; text-transform: uppercase; margin-bottom: 5px;"><span><svg width="12px" height="10px" viewbox="0 0 12 10"><polyline points="1.5 6 4.5 9 10.5 1"></polyline></svg></span>&emsp;{{ $attribute['name'] }}</label>
            </div>
            @endforeach
            </form>
          </div>
