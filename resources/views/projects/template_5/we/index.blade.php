			...
			<div class="container margin_60_35 add_bottom_30">
				...
				<!--div class="row justify-content-center align-items-center">
					<div class="col-lg-5 pr-lg-5 text-center d-none d-lg-block">
							<img src="/template_5/img/about_2.svg" alt="" class="img-fluid" width="350" height="268">
					</div>
					<div class="col-lg-5">
						<div class="box_about">
							<h2>Top Brands</h2>
							...
							<img src="/template_5/img/arrow_about.png" alt="" class="arrow_2">
						</div>
					</div>
				</div>
				...
				<div class="row justify-content-center align-items-center ">
					...
					<div class="col-lg-5 pl-lg-5 text-center d-none d-lg-block">
							<img src="/template_5/img/about_3.svg" alt="" class="img-fluid" width="350" height="316">
					</div>
				</div-->
			...
			<div class="owl-carousel owl-theme carousel_centered">
				...
				<!--div class="item">
					<a href="#">
						...
						</div><img src="/template_5/img/staff/4_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_5/img/staff/5_carousel.jpg" alt="">
					</a>
				</div-->
			</div>--}}
			...
			<div class="owl-carousel owl-theme carousel_centered">
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_5/img/staff/1_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_5/img/staff/2_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_5/img/staff/3_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
...
<!-- SPECIFIC CSS -->
    <link href="/template_5/css/about.css" rel="stylesheet">
