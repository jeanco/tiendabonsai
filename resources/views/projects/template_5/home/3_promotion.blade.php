...
{{--<div id="carousel-home-2">
			<div class="owl-carousel owl-theme">
				<div class="owl-slide cover" style="background-image: url(/template_5/img/slides/slide_home_1_vertical.jpg);">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url(/template_5/img/slides/slide_home_2_vertical.jpg);">
					<div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
						<div class="container">
							<div class="row justify-content-center justify-content-md-start">
								<div class="col-lg-12 static">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url(/template_5/img/slides/slide_home_3_vertical.jpg);">
					<div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
						<div class="container">
							<div class="row justify-content-center justify-content-md-start">
								<div class="col-lg-12 static">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url(/template_5/img/slides/slide_home_4_vertical.jpg);">
