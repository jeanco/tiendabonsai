		...
		<ul id="banners_grid" class="clearfix">
			...
			<li>
				<a href="index.html#0" class="img_container">
					<img src="/template_5/img/banners_cat_placeholder.jpg" data-src="/template_5/img/banner_2.jpg" alt="" class="lazy">
			...
			<li>
				<a href="index.html#0" class="img_container">
					<img src="/template_5/img/banners_cat_placeholder.jpg" data-src="/template_5/img/banner_3.jpg" alt="" class="lazy">
					<div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
