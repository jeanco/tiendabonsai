<aside class="col-lg-3" id="sidebar_fixed">
	                ...
	                <div class="filter_col">
						...
						<div id="table_category-attribute">
							@include('template_5.catalog.attribute_filter')
						</div>
	                ...
	                <!--div class="banner_menu">
													<a href="">
														<img src="template_5/img/banner_horizontal.png" data-src="template_5/img/banner_horizontal.png" width="400" height="550" alt="" class="img-fluid lazy loaded" data-was-processed="true">
													</a>
												</div-->
