<form id="profile_form">
  ...
  <div style="font: bold 20px 'Poppins', sans-serif; margin-bottom: 15px; color: var(--main-bg-color-font-menu);">Datos Personales</div>
  ...
  <div style="margin-bottom: 5px;">
    ...
    <input type="text" name="birthday" class="form-control datepicker" id="profile_birthday" value="{{ \Carbon\Carbon::parse($customer['birthday'])->format('d/m/Y') }}">
