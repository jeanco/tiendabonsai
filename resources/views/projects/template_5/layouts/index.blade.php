...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon" href="/template_5/img/apple-touch-icon-57x57-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="/template_5/img/apple-touch-icon-72x72-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="/template_5/img/apple-touch-icon-114x114-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="/template_5/img/apple-touch-icon-144x144-precomposed.png">
    ...
    <!-- BASE CSS -->
    <link href="/template_5/css/bootstrap.custom.min.css" rel="stylesheet">
...
@media (min-width: 768px) {
    ...
    <link href="/template_5/css/style.css" rel="stylesheet">
    <link href="/template_5/css/new_style.css" rel="stylesheet">

	<!-- SPECIFIC CSS -->
    <link href="/template_5/css/home_1.css" rel="stylesheet">
...
<body>
	...
	<div id="page">
    @include('template_5.layouts.sections.header_top')
	{{--@include('template_5.layouts.sections.header')--}}
    @include('template_5.layouts.sections.header')
    @include('template_5.layouts.sections.header_responsive')
	...
	<!-- /main -->
	  ...
	  <!--Footer section -->
        @include('template_5.layouts.sections.footer')
	...
	<!-- COMMON SCRIPTS -->
    <script src="/template_5/js/common_scripts.min.js"></script>
    <script type="text/javascript">
    ...
    <script src="/template_5/js/main.js"></script>
    <script src="/admin/plugins/axios/axios.js"></script>


	<!-- SPECIFIC SCRIPTS -->
    <script src="/template_5/js/carousel-home.min.js"></script>

	<script src="/template_5/js/custom-app.js"></script>
	<script src="/template_5/js/fill_cart.js"></script>
    <script src="/template_5/js/add_to_cart.js"></script>
    ...
    $('.input-search-product').select2({
        ignore:' ',
        ajax: {
            url: "/api/template_5/search-product",
            dataType: 'json',
            quietMillis: 1200,
            data: function (term) {
