						...
						<ul class="top_tools">
							<li>
								<div class="dropdown dropdown-cart">
									<a href="/checkout" class="" style="padding-top: 10px;"><img src="/template_5/img/carretilla.png" width="40px" style="    padding-top: 0px;"> <strong id="cart-header_quantity" style="background: #252525;
    padding: 1px 2px;
    border-radius: 7px; 
    position: absolute;
