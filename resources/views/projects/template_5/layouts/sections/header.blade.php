...
<header class="version_1 header_desktop">
    ...
    padding: 5px 0px 5px 0px;"></a>
					...
					<div class="col-xl-3 col-lg-2 d-lg-flex align-items-center justify-content-end text-center">
						...
						<a href="/suscripcion" class="btn_3 header_desktop" style="  margin: 0 15px 0 10px;  background: #2f2f2f; color: #fff !important;">Suscribete</a>
						...
						<a href="{{ $company_main->whatsapp }}" target="_blank" class="header_desktop"><img src="/template_5/img/whatsapp.png" class="button_select" width="40px" style="padding: 2px; border-radius: 20px; margin: 10px;"></a>
					</div>
				...
				<div class="row small-gutters">
					...
					<div class="col-xl-6 col-lg-7 col-md-6 d-none d-md-block">
						<div class="custom-search-input" style="margin-top: 10px;">
							<input type="text" placeholder="¿Qué estás buscando?" class="input-large focus form-control input-search-product">
							<button type="submit" style="margin-top: 10px;" id="search_button"></button>
						</div>
					</div>
