				...
				<div class="row justify-content-center" style="background: #212121; color: white;">
					<div class="col-lg-3">
						<div class="box_contacts">
							<!--i class="ti-email"></i-->
							<img src="/template_5/img/mensajes.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-6">
						<div class="box_contacts">
							...
							<img src="/template_5/img/ubicacion.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-3">
						<div class="box_contacts">
							...
							<img src="/template_5/img/cel.png" width="55px" style="    padding-top: 0px;">
...
<!-- SPECIFIC CSS -->
    <link href="/template_5/css/contact.css" rel="stylesheet">
...
<script type="text/javascript" src="/template_5/js/contact.js"></script>
...
<script type="text/javascript">
	...
	function fill_place_information(){
		axios.get(`/api/template_5/place/${$(`select[name=place_id]`).val()}`)
		.then((response) => {
