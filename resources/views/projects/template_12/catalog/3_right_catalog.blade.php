<div class="row small-gutters">
	@foreach ($products as $product)
		@if($product['product_child'])
			<div class="col-6 col-md-3 owl-item-card">
				<div class="grid_item ">
					...
					@if($product['product_child']['promotion_available'])
					<div class="brand_ribbon"><img src="{{ $product['product_child']['promotion_label_image'] }}"></div>
					@endif
					<a href="/catalogo/{{ $product['product_child']['slug'] }}">
					...
					<div class="price_box text-center my-3">
						@if($product['product_child']['promotion_available'])
							...
							<span class="new_price font-weight-bold" style="color: #d8203c; font-size: 24px;">S/{{ $product['product_child']['price_promotion'] }}</span><br>
							<span class="font-weight-bold" style="color: #d8203c;">Ahorras {{ $product['product_child']['promotion_discount'] }}</span>
						@else
							<span class="new_price font-weight-bold" style="color: #d8203c; font-size: 24px;">S/{{ $product['product_child']['price'] }}</span>
						@endif
					</div>
					@endif
					<div class="">
		...
		@elseif($product['id'] != $product['main_product_id'])
			@if($etiquette_flag)
				@if(count($product['etiquettes_detail']))
					<div class="col-6 col-md-3 owl-item-card">
						<div class="grid_item ">
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_12/img/products/product_placeholder_square_medium.jpg" data-src="/template_12/img/products/shoes/9.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
				<h3>Armor 720</h3>
