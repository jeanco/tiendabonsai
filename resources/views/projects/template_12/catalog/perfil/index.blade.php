	        ...
	        <div class="row">
	            ...
	            <div class="col-md-3">
	                ...
	                <div class="product_actions">
	                    <ul>
	                        <li>
	                            <a href="https://api.whatsapp.com/send?phone={{ $company_main->cel }}&text=Mayor%20informaci%C3%B3n%20del%20producto" target="_blank"><img src="/template_12/img/whatsapp.png" class="button_select" width="56px" style="padding: 1px; background: white;"><span>Whatsapp</span></a>
	                        </li>
	                        <li>
	                            <a href="tel:{{ $company_main->cel }}" ><img src="/template_12/img/contacto.jpg" class="button_select" width="40px" style="padding: 1px; background: white; padding-top: 9px;"><span style="padding-top: 9px;">Contactar</span></a>
	                        </li>
	                    </ul>
	                </div>
	                <!-- /product_actions -->
	        ...
	        <div class="owl-carousel owl-theme products_carousel">
	                ...
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_12/img/products/product_placeholder_square_medium.jpg" data-src="/template_12/img/products/shoes/5.jpg" alt="">
	                        </a>
	                    </figure>
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_12/img/products/product_placeholder_square_medium.jpg" data-src="/template_12/img/products/shoes/8.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="product-detail-1.html">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_12/img/products/product_placeholder_square_medium.jpg" data-src="/template_12/img/products/shoes/2.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="product-detail-1.html">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_12/img/products/product_placeholder_square_medium.jpg" data-src="/template_12/img/products/shoes/3.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="product-detail-1.html">
...
<!-- SPECIFIC CSS -->
    <link href="/template_12/css/product_page.css" rel="stylesheet">

@stop
@section('plugins-js')

<!-- SPECIFIC SCRIPTS -->
    <script  src="/template_12/js/carousel_with_thumbs.js"></script>
    <script  src="/template_12/js/add_cart_with_number.js"></script>
	<script>
		...
		document.querySelector(`#buy_now`)
			.addEventListener('click', function(e){
				...
				axios.get(`/api/template_12/product/${_productId}/is-there-stock?stock=1`)
					.then((response) => {
