...
<main class="bg_gray">
	...
	{{--<div class="top_banner general banner_contact" style="height: 250px;">
			...
			<!--img src="/template_12img/top_about.jpg" class="img-fluid" alt="" style="filter: brightness(0.5);"-->
		</div>--}}
			...
			<div class="row justify-content-center" style="background: #212121; color: white;">
					<div class="col-lg-3">
						<div class="box_contacts">
							<!--i class="ti-email"></i-->
							<img src="/template_12img/mensajes.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-6">
						<div class="box_contacts">
							...
							<img src="/template_12img/ubicacion.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-3">
						<div class="box_contacts">
							...
							<img src="/template_12img/cel.png" width="55px" style="    padding-top: 0px;">
...
<!-- SPECIFIC CSS -->
    <link href="/template_12css/contact.css" rel="stylesheet">
