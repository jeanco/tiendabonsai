...
<!-- SPECIFIC CSS -->
    <link href="/template_12/css/account.css" rel="stylesheet">
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<script src="/template_12/js/carousel-home.js"></script>
	<script src="/template_12/js/subscriptions.js"></script>
