  ...
  <div class="bg_gray py-5">
    <div class="container py-3">
      ...
      <div class="mb-4 text-justify" style="font-size: 16px; line-height: 1.2;">
        ¡Hola! Si tienes cualquier consulta o requieres una atención inmediata, te invitamos a usar nuestro canal de atención: central telefónica {{$company_main->phone}} o enviar un correo electrónico a {{$company_main->email}}. Gracias por ayudarnos a mejorar nuestro servicio. También puedes comunicarte directamente con el representante de la marca de tu producto, puedes encontrar las centrales telefónicas en tu certificado de garantía.
      </div>
      <div class="font-weight-bold" style="font-size: 16px; line-height: 1.2;">
        Razón Social: {{$company_main->name_company}}<br>
...
<script type="text/javascript" src="/template_12/js/claims.js"></script>
@stop
