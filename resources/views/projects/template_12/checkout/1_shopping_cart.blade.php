					  ...
					  <div class="card-body">
					    <div class="font-weight-bold" style="font-size: 1.15rem;">RESUMEN DE TU ORDEN</div>
							...
							<div class="text-center">
								@if(!Auth::check())
								<a href="/acceder" class="btn_1 full-width cart">CONTINUAR</a><br>		
								@else
...
<!-- SPECIFIC CSS -->
    <link href="/template_12/css/cart.css" rel="stylesheet">
@stop
@section('plugins-js')

<script src="/template_12/js/checkout.js"></script>
