...
<div class="container margin_60_35">
			<div class="main_title">
				<h2>Últimas novedades en {{ $company_main->business_name }}</h2>
				<!--span>Blog</span>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<a class="box_news" href="blog.html">
						<figure>
							<img src="/template_12/img/blog-thumb-placeholder.jpg" data-src="/template_12/img/blog-2.jpg" alt="" width="400" height="266" class="lazy">
				...
				<div class="col-lg-6">
					<a class="box_news" href="blog.html">
						<figure>
							<img src="/template_12/img/blog-thumb-placeholder.jpg" data-src="/template_12/img/blog-3.jpg" alt="" width="400" height="266" class="lazy">
							<figcaption><strong>28</strong>Dec</figcaption>
						</figure>
						<ul>
				...
				<div class="col-lg-6">
					<a class="box_news" href="blog.html">
						<figure>
							<img src="/template_12/img/blog-thumb-placeholder.jpg" data-src="/template_12/img/blog-4.jpg" alt="" width="400" height="266" class="lazy">
							<figcaption><strong>28</strong>Dec</figcaption>
						</figure>
						<ul>
