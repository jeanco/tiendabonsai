	<div class="container margin_60_35 add_bottom_30">
		<div class="mb-3 text-center" style="font-size: 2em; padding-bottom: 20px;"><b>Novedades en {{ $company_main->business_name }}</b></div>
	<ul id="banners_grid" class="clearfix">
			...
			<!--li>
				<a href="index.html#0" class="img_container">
					<img src="/template_7/img/banners_cat_placeholder.jpg" data-src="/template_7/img/banner_2.jpg" alt="" class="lazy">
			...
			<li>
				<a href="index.html#0" class="img_container">
					<img src="/template_7/img/banners_cat_placeholder.jpg" data-src="/template_7/img/banner_3.jpg" alt="" class="lazy">
					<div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
