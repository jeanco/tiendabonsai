...
<main class="font-template">
  ...
  <div class="bg_white py-5">
    <div class="container">
      <div class="font-weight-bold text-uppercase mb-4" style="color: var(--main-bg-color-secundario); font-size: 18px;">SOPORTE TÉCNICO {{$company_main->business_name}}</div>
  ...
  <div class="bg_white py-5">
    <div class="container">
      <div class="text-center mb-3" style="font-size: 2rem; color: var(--main-bg-color-secundario);">En {{$company_main->business_name}} respondemos a todas tus preguntas.</div>
      <div class="accordion" id="quest_area">
        <div class="p-3" style="border-bottom: 1px solid #000;">
          <a href="javascript:void(0);" class="font-weight-bold" data-toggle="collapse" data-target="#quest_1" style="font-size: 16px;">1. ¿Cómo compras en {{$company_main->business_name}}?</a>
        ...
        <div class="p-3" style="border-bottom: 1px solid #000;">
          <a href="javascript:void(0);" class="font-weight-bold" data-toggle="collapse" data-target="#quest_2" style="font-size: 16px;">2. ¿Qué productos encontrarás en {{$company_main->business_name}}?</a>
          <div id="quest_2" class="collapse pt-3" aria-labelledby="headingTwo" data-parent="#quest_area">
            Tiendas Kamasa es una empresa de origen tacneño, dedicada a la comercialización y venta directa de electrodomésticos, tales como línea blanca (refrigeradoras, lavadoras, cocinas, horno microondas etc.), línea marrón (televisores, reproductores de audio y video, etc.) y pequeños electrodomésticos (licuadoras, tostadoras, cafeteras, etc.).
          </div>
        </div>
        <div class="p-3" style="border-bottom: 1px solid #000;">
