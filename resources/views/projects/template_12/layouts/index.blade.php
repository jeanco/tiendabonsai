...
<head>
    ...
    <!-- BASE CSS -->
    <link href="/template_12/css/bootstrap.custom.min.css" rel="stylesheet">
...
@media (min-width: 768px) {
    ...
    <link href="/template_12/css/style.css" rel="stylesheet">

	<!-- SPECIFIC CSS -->
    <link href="/template_12/css/home_1.css" rel="stylesheet">
    <link href="/template_12/css/new_style.css" rel="stylesheet">
...
<body class="scroll_edit font-template">
	...
	<div id="page">
     ...
     @include('template_12.layouts.sections.header_top')  
	 @include('template_12.layouts.sections.header')
     @include('template_12.layouts.sections.header2')
	...
	<!-- /main -->
	  ...
	  <!--Footer section -->
        @include('template_12.layouts.sections.footer')
	...
	<!-- COMMON SCRIPTS -->
    <script src="/template_12/js/common_scripts.min.js"></script>
    ...
    <script src="/template_12/js/main.js"></script>
    <script src="/admin/plugins/axios/axios.js"></script>


	<!-- SPECIFIC SCRIPTS -->
    <script src="/template_12/js/carousel-home.min.js"></script>
    
  	<script src="/template_12/js/custom-app.js"></script>
  	<script src="/template_12/js/fill_cart.js"></script>
    <script src="/template_12/js/add_to_cart.js"></script>
    ...
    {{-- Suscriptions  --}}
    <script type="text/javascript" src="{{ URL::asset('template_12/js/subscriptions.js') }}"></script>
