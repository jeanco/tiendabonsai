  ...
  <body>
    <div class="content-margin" style="margin-top: 50px;">
      <div class="row" style="align-items: center; display: flex; margin-bottom: 40px">
        <div class="col-6"><img src="{{ $company_main->logotype_thumb }}" alt="images" style="height: 70px;" class="img-reponsive"></div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="pdf-table">
              ...
              <span style="text-decoration: line-through; font-size: 13px;">{{ $product['price']+$product['discount'] }}</span> <br>{{ $product['price'] }}
              @else
              {{ $product['price']+$product['discount'] }}
              @endif</td>
            <td class="pdf-table">{{ $product['discount'] }}</td>
