			...
			<div class="col-xl-5 col-lg-6 col-md-8">
				<div class="box_account">
					...
					<div class="form_container">
						...
						<div class="form-group">
							<input type="password" class="form-control" name="password_confirmation" id="" value="" placeholder="Confirmar contraseña*">
...
<script src="/template_12/js/register_user.js"></script>
