<div class="row small-gutters">
    ...
    opacity: 1;">
			...
			<div class="price_box text-center my-3">
				...
				@else
					<span class="new_price font_bold" style="color: #d8203c; font-size: 24px;">{{ ($product['unit_price']) ? "S/".$product['unit_price']['price'] : '' }}</span>
				@endif
			</div>
			{{--@endif--}}
		...
		<div class="row">
			...
			<div class="col-6" style="text-align: center; padding-right: 4px !important; padding-left: 4px !important;">
				<a   href="javascript:void(0);" class="btn_1 add_to_cart {{ $product['stock'] <= 0 || !($product['unit_price']) ? 'disabled' : '' }}" title="Agregar al carrito" data-index="{{ $product['id'] }}" style="width: 110px;border-radius: 10px !important;" >Agregar</a>
			</div>
