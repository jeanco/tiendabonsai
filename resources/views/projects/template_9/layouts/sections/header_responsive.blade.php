      ...
      <div class="container">
         <div class="row small-gutters">
            <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
               <div id="logo">
                  <a href="/"><img src="{{ $company_main->logotype }}" alt=""  style="height: 25px;
                     padding: 10px 0px 10px 0px;"></a>
               </div>
            </div>
      ...
      <div class="container">
         <div class="row small-gutters">
            ...
            <div class="col-xl-3 col-lg-2 col-md-3">
               <ul class="top_tools">
               	  <li>
               	  	<a href="{{ $company_main->whatsapp }}" target="_blank" class="header_desktop"><img src="/template_9/img/whatsapp.png" class="button_select" width="40px" style="padding: 4px;  "></a>
               	  </li>	
                  <li>
                  ...
                  <li>
                     <div id="logo">
                  <a href="/"><img src="{{ $company_main->logotype }}" alt=""  style="height: 25px;"></a>
               </div>
                  </li>
                  <li>
