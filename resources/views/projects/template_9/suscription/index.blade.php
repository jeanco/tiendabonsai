...
@section('content')
		...
		<div class="top_banner general top_banner_suscription">
			...
			<!--img src="/template_9/img/top_about.jpg" class="img-fluid" alt="" style="filter: brightness(0.5);"-->
		</div>
		<!--/top_banner-->
	...
	<!--/main-->
		...
		<div class="popup_content newsletter">
            ...
            <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center">
                <figure><img src="/template_9/img/newsletter_img.jpg" alt=""></figure>
            </div>
            <div class="col-md-7">
				<div class="content">
					<div class="wrapper">
					<img src="/template_9/img/logo_black.svg" alt="" width="100" height="35">
...
<!-- SPECIFIC CSS -->
    <link href="/template_9/css/account.css" rel="stylesheet">
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<!--script src="/template_9/js/carousel-home.js"></script-->
	<script src="/template_9/js/subscriptions.js"></script>
