        ...
        <div class="container">
            <!--div class="heading-sub">
                ...
                <ul class="other-link-sub pull-right">
                    <li><a href="contact_us.html#home">Home</a></li>
                    <li><a href="contact_us.html#pages">Pages</a></li>
                    <li><a class="active" href="contact_us.html#aboutus">About Us</a></li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 contact-column-inner">
                        <div class="contact-box">
                            ...
                            <div class="contact-box-information">
                                {{ $company_main->cel }} | {{ $company_main->phone }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 contact-column-inner">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="note" id="contact_msg" tabindex="2" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
