...
<html>
  ...
  <body>
    <div style="margin: 50px 20px; width: 600px; font: 400 13.3333px Arial;">
          <div style="background-color: #2b2b2b; padding: 25px 0px; text-align: center;">
          ...
          <div style="padding: 50px 0px; background: #fff8f8;">
                ...
                <table width="100%">
                  ...
                  <tr>
                    <td width="19%"></td>
                    <td style="font-size: 14px; text-align: center;">Aquí tienes tu codigo de descuento para tu próxima compra. Puedes canjearlo hasta el {{ $date_formatted }}.</td>
                    <td width="19%"></td>
                  </tr>
                </table>
                ...
                <table width="100%" style="margin: 30px 0px;">
                  ...
                  <td width="50%" style="text-align: center;"><a href="/mi-cupon-pdf/{{ $order_id }}"><button type="button" class="btn btn-cupon">Descargar</button></a></td>
                  </tr>
                  <tr>
