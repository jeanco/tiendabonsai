  <div style="font: bold 20px 'Poppins', sans-serif; margin-bottom: 15px; color: #01c5a7">Datos Personales</div>
  <input type="hidden" name="" id="profile_id" value="{{ $customer['user_id'] }}">
  <div style="margin-bottom: 5px;">
    <span style="font-size: 15px;">DNI</span>
    <input type="text" class="form-control" id="profile_ruc" value="{{ $customer['identity_document'] }}" disabled=true>
  </div>
  <div style="margin-bottom: 5px;">
  ...
  <div style="margin-bottom: 5px;">
    ...
    <input type="text" class="form-control" id="profile_cel-whatsapp" value="{{ $customer['cel_whatsapp'] }}" disabled=true>
  </div>
  <div style="margin-bottom: 5px;">
  ...
  <div style="margin-bottom: 5px;">
    ...
    <input type="password" name="" class="form-control" id="profile_password" value="">
    <div id="profile-password-error" class="mensaje-error text-danger"></div>
  </div>
  <div style="margin-bottom: 20px;">
    <span style="font-size: 15px;">Repetir Contraseña</span>
    <input type="password" name="" class="form-control" id="profile_password-verification" value="">
