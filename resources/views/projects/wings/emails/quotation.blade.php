...
<body>
  <article style="color: #828286; display: block; font-size: 18px; margin: 0 auto; max-width: 650px; text-align: center" class="email">
    ...
    <p style="margin-bottom: 0" class="mb0"><strong>Vehiculo a cotizar</strong></p>
    <p style="margin-top: 0" class="mt0">{{ $vehicle_name }}</p>
    <p style="margin-bottom: 0" class="mb0"><strong>Contacto</strong></p>
    <p style="margin: 0" class="m0">{{ $cellphone }}</p>
    <p style="margin: 0" class="m0">{{ $email }}</p>
    <p style="margin-bottom: 0" class="mb0"><strong>Ciudad</strong></p>
    <p style="margin-top: 0" class="mt0">{{ $city_name }}</p>
    <hr>
