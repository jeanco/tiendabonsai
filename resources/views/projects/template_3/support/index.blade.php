...
<main class="font-template">
  ...
  <div class="bg_white py-5">
    <div class="container">
      <div class="text-center mb-3" style="font-size: 2rem; color: var(--main-bg-color-secundario);">En Kamasa respondemos a todas tus preguntas.</div>
      <div class="accordion" id="quest_area">
        <div class="p-3" style="border-bottom: 1px solid #000;">
          <a href="javascript:void(0);" class="font-weight-bold" data-toggle="collapse" data-target="#quest_1" style="font-size: 16px;">1. ¿Cómo compras en www.kamasa.pe?</a>
        ...
        <div class="p-3" style="border-bottom: 1px solid #000;">
          <a href="javascript:void(0);" class="font-weight-bold" data-toggle="collapse" data-target="#quest_2" style="font-size: 16px;">2. ¿Qué productos encontrarás en www.kamasa.pe?</a>
