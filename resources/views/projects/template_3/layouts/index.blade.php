...
<head>
    ...
    <!-- Favicons-->
    <link href="/template_3/img/kamasa_ico.png" type="images/x-icon" rel="shortcut icon">
    ...
    <!-- BASE CSS -->
    <link href="/template_3/css/bootstrap.custom.min.css" rel="stylesheet">
...
@media (min-width: 768px) {
    ...
    <link href="/template_3/css/style.css" rel="stylesheet">

	<!-- SPECIFIC CSS -->
    <link href="/template_3/css/home_1.css" rel="stylesheet">
    <link href="/template_3/css/new_style.css" rel="stylesheet">
...
<!--body class="scroll_edit"-->
	...
	<div id="page">
     ...
     @include('template_3.layouts.sections.header_top')
	 @include('template_3.layouts.sections.header')
     @include('template_3.layouts.sections.header2')
	...
	<!-- /main -->
	  ...
	  <!--Footer section -->
        @include('template_3.layouts.sections.footer')
            ...
            <div class="row no-gutters">
                <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                    ...
                    <div class="content">
                        <div class="wrapper">
                        <img src="/template_3/img/notification_email.png" alt="" width="50%">
	...
	<!-- COMMON SCRIPTS -->
    <script src="/template_3/js/common_scripts.min.js"></script>
    ...
    <script src="/template_3/js/main.js"></script>
    <script src="/admin/plugins/axios/axios.js"></script>


	<!-- SPECIFIC SCRIPTS -->
    <script src="/template_3/js/carousel-home.min.js"></script>

  	<script src="/template_3/js/custom-app.js"></script>
  	<script src="/template_3/js/fill_cart.js"></script>
    <script src="/template_3/js/add_to_cart.js"></script>
   ...
   /* $(window).on('load', function() {
    ...
    {{-- Suscriptions  --}}
    <script type="text/javascript" src="{{ URL::asset('template_3/js/subscriptions.js') }}"></script>
