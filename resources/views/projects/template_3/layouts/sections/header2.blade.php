		...
		<div class="main_header" style="border-bottom: 1px solid #e1e1e1;">
			<div class="container">
				<div class="row small-gutters" style=" margin-bottom: 0px !important;">
					<div class="col-6 align-items-center" style="margin-top: 9px;">
						<div id="logo">
							<a href="/"><img src="{{ $company_main->logotype }}" alt="" width="100%"></a>
						</div>
					</div>

					<div class="col-6 align-items-center " style="margin-top: 8px; text-align: center;">
						<a href="/suscripcion" class="btn_4">Suscribirme</a>
						<a href="{{ $company_main->whatsapp }}" target="_blank"><img src="/template_5/img/whatsapp.png" class="button_select" width="33px" style="  "></a>
								...
								<li>
									...
									<div id="menu">
										<ul>
											...
											<li>
												<span>
													<a href="/catalogo?categoria={{ $category['slug'] }}&subcategoria=">
														<span class="icon_menu"><img src="{{ $category['icon'] }}" style="width: 24px;"></span>
														{{ $category['name'] }}
													</a>
												</span>
												<ul>
													@foreach ($category['subcategories'] as $subcategory)
														<li>
															<a href="/catalogo?categoria={{ $category['slug'] }}&subcategoria={{ $subcategory['slug'] }}">{{ $subcategory['name'] }}</a>
														</li>
													@endforeach
												</ul>
											</li>
											...
											<li style="text-align: center;     padding-top: 20px;"><a href="/nosotros">Nosotros</a></li>
												...
												<li style="text-align: center;"><a href="/club-de-novios">Club Novios</a></li>
												...
												@if(!Auth::check())
					                             ...
					                             @else
													...
													<li class="megamenu submenu">
														<a href="javascript:void(0);" class="show-submenu-mega">Mi Cuenta</a>
						...
						<ul class="top_tools">
							...
							<li style="margin-right: 15px;">
								<div class="dropdown dropdown-cart">
									<a href="/checkout" class="cart_bt" style="color: var(--main-bg-color-primario);"><img src="/template_3/img/camioncito.png" width="38px" style="    padding-top: 0px;"> <strong id="cart-header_quantity_mobil" style="top: 16px; right: -13px;">0</strong></a>
								...
								<div class="dropdown dropdown-access">
									...
									<div class="dropdown-menu">
										...
										<ul>
											...
											<li>
												<a href="/miperfil"><i class="ti-user"></i>Mi Cuenta</a>
											</li>
											<li>
												<a href="/logout"><i class="ti-share-alt"></i>Cerrar Sesión</a>
											</li>
							...
							<li>
								<a href="#menu" class="btn_cat_mob font_bold" style="width: 130px;">
									<div class="hamburger hamburger--spin" id="hamburger" style="margin-top: 22px;">
