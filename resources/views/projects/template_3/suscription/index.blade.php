...
@section('content')
		...
		<div class="top_banner general">
			...
			<!--img src="/template_3/img/top_about.jpg" class="img-fluid" alt="" style="filter: brightness(0.5);"-->
		</div>
		<!--/top_banner-->
...
<!-- SPECIFIC CSS -->
    <link href="/template_3/css/account.css" rel="stylesheet">
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<script src="/template_3/js/carousel-home.js"></script>
	<!--script src="/template_3/js/subscriptions.js"></script-->
