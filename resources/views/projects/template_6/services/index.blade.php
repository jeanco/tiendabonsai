...
<main class="font-template">
  <div class="top_banner general">
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-md-6 text-center">
							<div class="text-white font-weight-bold mb-4" style="font-size: 3.5rem; line-height: 1;">Kamasa<br>está a tu servicio</div>
			...
			<img src="https://dl.dropboxusercontent.com/s/itqoq3ae83cafy8/img_servicio.jpg?dl=0" class="img-fluid" alt="" style="height: 100%;">
	</div>
  <div class="bg_white">
      ...
      <div class="row justify-content-between">
        <div class="col-md-5">
          <div class="font-weight-bold mb-2" style="color: var(--main-bg-color-primario); font-size: 25px; line-height: 1.2;">
            ENTREGA A DOMICILIO Y PUESTA EN MARCHA
          </div>
          <img src="https://dl.dropboxusercontent.com/s/7o8s85qem123dk3/1527176572-1527176572.png?dl=0" alt="" style="max-height: 200px;">
        </div>
        <div class="col-md-6">
          <div style="font-size: 16px; line-height: 1.2;">
            <span class="font-weight-bold" style="font-size: 16px;">Costo: S/ 49.90</span><br><br>
            Llevamos tus productos a tu domicilio u oficina y realizamos la puesta en marcha incluyendo una demostración de uso del electrodomésticos, todo por el precio de S/ 49.90, aplica para entregas en Tacna Metropolitana.
          </div>
        </div>
      </div>
