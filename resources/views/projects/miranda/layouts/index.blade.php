...
<html class="no-js" lang="en">
  <head>
      ...
      <link href="/miranda/img/miranda.ico" type="images/x-icon" rel="shortcut icon">
      ...
      <link rel="stylesheet" href="/miranda/newstyles.css">
      <!-- Font Awesome -->
  ...
  <body>
     ...
     <div class=" btn-what-1">
       <button class="clik_whatsapp btn-what " value="{{ $company_main['cel'] }}">
      ...
      <div class="wrapper white_bg">
          <!--Header section -->
          @include('miranda.layouts.sections.header')
          <!--Page content -->
          @yield('content')
          <!--Footer section -->
          @include('miranda.layouts.sections.footer')
      </div>
      ...
      <section class="chat-container">
        ...
        <div class="chat-content">
          <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fmirandainmobiliariaperu%2F&tabs=messages&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=false&appId=302703559837888" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
        </div>
      </section>
