...
<main style="background-color: #fafafa;">
     ...
     {{-- <div class="header_desktop">
     	 @include('template_1.home.0_banner_video')
     </div> --}}


    <div class="">
    	{{-- @include('template_1.home.1_banner') --}}
      @include('template_1.home.15_banner_image')
    </div>

    @include('template_1.home.13_offers')

    {{--@include('template_1.home.8_we')--}}

    @include('template_1.home.2_category')

    {{--@include('template_1.home.11_more_options')--}}

    @include('template_1.home.4_banner_promotion')

    {{--@include('template_1.home.12_more_sellers')--}}

    {{-- @include('template_1.home.3_promotion') --}}

    {{--  @include('template_1.home.6_brands') --}}

    @include('template_1.home.5_featured')

    @include('template_1.home.14_banner_offers')


    @include('template_1.home.7_blog')
    {{-- @include('template_1.home.9_social_netwok')  --}}
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<script src="/template_1/js/modernizr.js"></script>
	<!--script src="/template_1/js/video_header.min.js"></script>
	<script>
		// Video Header
		HeaderVideo.init({
	...
	<script src="/template_1/js/isotope.min.js"></script>
	<script src="/template_1/js/carousel-home-2.js"></script>
	<script>
		// Isotope filter
