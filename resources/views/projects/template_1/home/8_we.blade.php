<div class="container margin_60_35 add_bottom_30">
				...
				<!--div class="row justify-content-center align-items-center">
					<div class="col-lg-5 pr-lg-5 text-center d-none d-lg-block">
							<img src="/template_1/img/about_2.svg" alt="" class="img-fluid" width="350" height="268">
					</div>
					<div class="col-lg-5">
						<div class="box_about">
							<h2>Top Brands</h2>
							...
							<img src="/template_1/img/arrow_about.png" alt="" class="arrow_2">
						</div>
					</div>
				</div>
				...
				<div class="row justify-content-center align-items-center ">
					...
					<div class="col-lg-5 pl-lg-5 text-center d-none d-lg-block">
							<img src="/template_1/img/about_3.svg" alt="" class="img-fluid" width="350" height="316">
					</div>
				</div-->
