			...
			<div class="container">
								...
								<div class="dropdown dropdown-cart" style="padding-left: 20px;">
									<a href="/checkout">
										<div  class="row align-items-center" style="height: 100%">
											<img src="/template_1/img/icon_5_.png" width="35px">
              ...
              <li>
								<div class="dropdown dropdown-access" style="padding-left: 20px;">
									<a href="/acceder">
										<div  class="row align-items-center" style="height: 100%">
											<img src="/template_1/img/icon_4_.png" width="35px">
							...
							<li>
								<div  class="row align-items-center" style="height: 60px;">
									...
									<a class="btn_menu_1 text_pedidos" href="{{ $company_main->whatsapp }}" target="_blank">
										<img src="\template_1\img\whatsapp_ico.png" alt="" class="img_none" style="height: 17px;">
										{{ $company_main->cel }}
									</a>
								</div>
							</li>
