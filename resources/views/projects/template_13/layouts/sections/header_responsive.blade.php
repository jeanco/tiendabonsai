      ...
      <div class="container">
         <div class="row small-gutters">
            ...
            <div class="col-xl-3 col-lg-2 col-md-3">
               <ul class="top_tools">
               	  <li style="">
                      <form action="/api/template_9/set-place-no-ajax", method="POST" id="place_form_responsive">
                              {{ csrf_field() }}
                              <div class="custom-select-form" style="padding-top: 15px;">
                                 <select class="wide add_bottom_5 " name="place_id" id="place_select_responsive">
               	  	...
               	  	<!--a href="{{ $company_main->whatsapp }}" target="_blank" class="header_desktop"><img src="/template_13/img/whatsapp.png" class="button_select" width="40px" style="padding: 4px;  "></a-->
               	  </li>
                  <li>

                     <div class="dropdown dropdown-cart">
                        <a href="/checkout" style="padding-top: 5px;">
                          <img src="/template_13/img/icon_5_.png" width="30px">
                              ...
                              <ul id="cart_products">
                                 <!--li>
                                    <a href="product-detail-1.html">
                                    	<figure><img src="/template_13/img/products/product_placeholder_square_small.jpg" data-src="/template_13/img/products/shoes/thumb/1.jpg" alt="" width="50" height="50" class="lazy"></figure>
                                    ...
                                    <li>
                                    <a href="product-detail-1.html">
                                    	<figure><img src="/template_13/img/products/product_placeholder_square_small.jpg" data-src="/template_13/img/products/shoes/thumb/2.jpg" alt="" width="50" height="50" class="lazy"></figure>
