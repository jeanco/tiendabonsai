...
<head>
    ...
    <meta name="theme-color" content="var(--main-bg-color-secundario)">
    ...
    <link rel="apple-touch-icon" type="image/x-icon" href="/template_13/img/apple-touch-icon-57x57-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="/template_13/img/apple-touch-icon-72x72-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="/template_13/img/apple-touch-icon-114x114-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="/template_13/img/apple-touch-icon-144x144-precomposed.png">
    ...
    <!-- BASE CSS -->
    <link href="/template_13/css/bootstrap.custom.min.css" rel="stylesheet">
...
@media (min-width: 768px) {
    ...
    <link href="/template_13/css/style.css" rel="stylesheet">
    <link href="/template_13/css/new_style.css" rel="stylesheet">

	<!-- SPECIFIC CSS -->
    <link href="/template_13/css/home_1.css" rel="stylesheet">
...
<body style="font-family: 'Montserrat', sans-serif;">
	...
	<div id="page">
    @include('template_13.layouts.sections.header_top')
	{{--@include('template_13.layouts.sections.header')--}}
    @include('template_13.layouts.sections.header')
    @include('template_13.layouts.sections.header_responsive')
	  ...
	  <!--Footer section -->
        @include('template_13.layouts.sections.footer')
                        ...
                        <p>¿Dónde te encuentras ahora?</p>
                         <div class="row">
                            @foreach($places as $key => $place)
                                ...
                                <div class="col-md-6">
                                    <form action="/api/template_13/set-place-no-ajax", method="POST">
                                {{ csrf_field() }}
    ...
    {{--@if(!isset($place_id_selected))
      @include('template_13.layouts.subscription_modal')
	...
	<!-- COMMON SCRIPTS -->
    <script src="/template_13/js/common_scripts.min.js"></script>
    <script type="text/javascript">
    ...
    <script src="/template_13/js/main.js"></script>
    <script src="/admin/plugins/axios/axios.js"></script>


	<!-- SPECIFIC SCRIPTS -->
    <script src="/template_13/js/carousel-home.min.js"></script>

	<script src="/template_13/js/custom-app.js"></script>
	<script src="/template_13/js/fill_cart.js"></script>
    <script src="/template_13/js/add_to_cart.js"></script>
    ...
    {{-- Suscriptions  --}}
    <script type="text/javascript" src="{{ URL::asset('template_13/js/subscriptions.js') }}"></script>
   ...
   /* $(window).on('load', function() {
    ...
    $(`#place_select`).on('change', function(){
     ...
     $(`#place_select_responsive`).on('change', function(){
        localStorage.removeItem(`cart`);
        $(`#place_form_responsive`).submit();
    });
