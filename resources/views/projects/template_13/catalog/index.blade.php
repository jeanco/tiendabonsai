...
<main>
	  <div class="container ">
	      <div class="row pt-4">
	        	@include('template_13.catalog.1_left_filters')
	            <!-- /col -->
    ...
    margin-left: 70px; font-size: 17px;">
					...
					<!-- /toolbox -->
									<div id="table_data_product">
										@include('template_13.catalog.3_right_catalog')
									</div>
	            </div>
	            <!-- /col -->
	      </div>
...
<!-- SPECIFIC CSS -->
    <link href="/template_13/css/listing.css" rel="stylesheet">
@stop
@section('plugins-js')

<!-- SPECIFIC SCRIPTS -->
	<script src="/template_13/js/catalog.js"></script>
	<script src="/template_13/js/sticky_sidebar.min.js"></script>
	<script src="/template_13/js/specific_listing.js"></script>
