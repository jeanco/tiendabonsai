...
<div class="row">
    ...
    <div class="col-md-6">
        <article class="blog">
            ...
            <div class="post_info">
                ...
                <ul>
                    <li>
                    <div class="thumb"><img src="{{ ($blog['user']['user_image_thumb']) ? $blog['user']['user_image_thumb'] : '/template_13/img/avatar.jpg' }}" alt=""></div> {{ $blog['user']['first_name'] }}
                    </li>
    ...
    <div class="col-md-6">
        <article class="blog">
            <figure>
                <a href="blog-post.html"><img src="/template_13/img/blog-2.jpg" alt="">
            ...
            <div class="post_info">
                ...
                <ul>
                    <li>
                        <div class="thumb"><img src="/template_13/img/avatar.jpg" alt=""></div> Admin
                    </li>
                    <li><i class="ti-comment"></i>20</li>
                </ul>
            </div>
    ...
    <div class="col-md-6">
        <article class="blog">
            <figure>
                <a href="blog-post.html"><img src="/template_13/img/blog-3.jpg" alt="">
                    <div class="preview"><span>Read more</span></div>
                </a>
            </figure>
            <div class="post_info">
    ...
    <div class="col-md-6">
        <article class="blog">
            <figure>
                <a href="blog-post.html"><img src="/template_13/img/blog-4.jpg" alt="">
                    <div class="preview"><span>Read more</span></div>
                </a>
            </figure>
            <div class="post_info">
    ...
    <div class="col-md-6">
        <article class="blog">
            <figure>
                <a href="blog-post.html"><img src="/template_13/img/blog-5.jpg" alt="">
                    <div class="preview"><span>Read more</span></div>
                </a>
            </figure>
            <div class="post_info">
    ...
    <div class="col-md-6">
        <article class="blog">
            <figure>
                <a href="blog-post.html"><img src="/template_13/img/blog-6.jpg" alt="">
                    <div class="preview"><span>Read more</span></div>
                </a>
            </figure>
            <div class="post_info">
