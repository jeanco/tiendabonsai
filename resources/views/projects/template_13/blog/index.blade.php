		...
		<div class="container margin_30">
			...
			<div class="row" >
				...
				<div class="col-lg-9" id="table_data_blog">
					@include('template_13.blog.list_blogs')
					<!-- /pagination -->
				</div>
				<!-- /col -->
				...
				<aside class="col-lg-3">
					...
					<div class="widget">
						...
						<ul class="comments-list">
							...
							<li>
								<div class="alignleft">
									<a href="blog.html#0"><img src="/template_13/img/blog-6.jpg" alt=""></a>
								</div>
							...
							<li>
								<div class="alignleft">
									<a href="blog.html#0"><img src="/template_13/img/blog-4.jpg" alt=""></a>
								</div>
								<small>Category - 11.08.2016</small>
								<h3><a href="blog.html#" title="">Verear qualisque ex minimum...</a></h3>
							</li>
...
@stop
@section('plugins-js')
	<script src="/template_13/js/blogs.js"></script>
