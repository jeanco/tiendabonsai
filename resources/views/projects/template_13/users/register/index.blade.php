			...
			<div class="col-xl-6 col-lg-6 col-md-8">
				<div class="box_account">
					...
					<div class="form_container">
						...
						<hr>
						<div class="form-group">
							<label class="container_check">Acepto <a href="/terminos-y-condiciones">Términos y Condiciones</a>
								<input type="checkbox" id="user_terms">
								<span class="checkmark"></span>
							</label>
						</div>
						<div class="text-center">
							<button class="btn sales_car btn-block full-width" id="register-user__save">Registrarme</button>
...
<script src="/template_13/js/register_user.js"></script>
