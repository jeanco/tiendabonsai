<div style="font: bold 20px 'Poppins', sans-serif; margin-bottom: 15px; color: #ff6600">Lista de Pedidos</div>
        ...
        <tbody>
          ...
          <tr>
             ...
             <td>
               ...
               <a href="/pdf-pedido/{{ $order['id'] }}" target="_blank" class="btn-clear">
