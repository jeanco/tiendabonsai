...
@section('content')
	...
	<div class="container margin_30">
		...
		<div class="page_header">
			@if(!Auth::check())
			<h1>Registra tus datos para realizar el pedido</h1>
			@if (session()->has('data'))
					  ...
					  @if(!Auth::check())
						<li class="nav-item" id="pivot">
							...
							<div class="tooltip" id="tooltip">
									<div class="thumb">
										<img src="/template_15/img/paso_checkout.png" alt="">
									</div>
									<div class="info">
										<h4 class="titulo">Deja tus datos</h4>
									<p class="resumen">Escriba sus datos completos para poder hacer el envio o realizar el pedido con exactitud.</p>
										<!--p class="resumen">
						...
						<div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
							<form id="checkout_form">
								...
								<div class="form-group">
									...
									<input type="text" value="{{ $identity_document }}" name="identity_document" class="form-control" placeholder="Ingrese el N° de DNI ó RUC">
						...
						<div class="payments method-payments">
							<form id="other-billing_form">
								...
								<div class="payments">
									<ul>
										<li>
											<label class="container_radio">Recojo en Tienda<a href="#0" class="info" data-toggle="modal" data-target="#payments_store"></a>
										...
										<li>
											<label class="container_radio">Envío a domicilio (Delivery)<a href="#0" class="info" data-toggle="modal" data-target="#home_delivery"></a>
...
<!-- 							<div class="form-group">
						...
						<div class="payments method-payments_">
							<ul >
								...
								<li>
									...
									<div style="padding-left: 30px; font-size: 10px;">
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="box_general summary">
						...
						<button class="btn_1 full-width" id="checkout__save">Confirmar el pedido</button>

						
						<div id="myPaymentForm" class="myPaymentForm" >
						  <!-- payment form -->
...
<script>
  ...
  //   	// Other address Panel
	...
	<script src="/template_15/js/orden_info.js"></script>
	<script src="https://checkout.culqi.com/js/v3"></script>
	<script src="/template_2/js/tooltips.js"></script>

	   <script 
       src="https://static.micuentaweb.pe/static/js/krypton-client/V4.0/stable/kr-payment-form.min.js" 
       kr-public-key="{{ env('IZIPAY_PUBLICKEY') }}" 
       kr-post-url-success="/api/template_15/order-confirm-payment-izipay" kr-post-url-refused="/api/template_15/error" kr-language="es-ES">
      </script>
