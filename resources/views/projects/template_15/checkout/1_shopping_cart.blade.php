...
@section('content')
	...
	<main class="bg_gray">
		...
		<table class="table table-striped cart-list">
							...
							<tbody id="cart_tbody">
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_15/img/products/product_placeholder_square_small.jpg" data-src="/template_15/img/products/shoes/1.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_15/img/products/product_placeholder_square_small.jpg" data-src="/template_15/img/products/shoes/2.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_15/img/products/product_placeholder_square_small.jpg" data-src="/template_15/img/products/shoes/3.jpg" class="lazy" alt="Image">
										</div>
		...
		<div class="box_cart">
			...
			<a href="/checkout/info" id="pivot" class="btn_1 full-width cart">Continuar el pedido</a>
			<div class="tooltip" id="tooltip">
					<div class="thumb">
						<img src="/template_15/img/paso_checkout.png" alt="">
					</div>
					<div class="info">
						<h4 class="titulo">Continuar el pedido</h4>
						<p class="resumen">Click aquí para registrar sus datos y realizar su pedido seguro.</p>
						<!--p class="resumen">
...
<!-- SPECIFIC CSS -->
    <link href="/template_15/css/cart.css" rel="stylesheet">
...
<script src="/template_15/js/checkout.js"></script>
