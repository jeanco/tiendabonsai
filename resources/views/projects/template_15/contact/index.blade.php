...
<main class="bg_gray">
	...
	<div class="top_banner general banner_contact" style="height: 250px;">
			<div class="opacity-mask banner_contact d-flex align-items-md-center"  data-opacity-mask="rgba(0, 0, 0, 0.1)" style="background:  url({{ isset( $gallery_company[5]->resource) ? $gallery_company[5]->resource:  ''  }}); background-size: cover; height: 250px;">
			...
			<!--img src="/template_15/img/top_about.jpg" class="img-fluid" alt="" style="filter: brightness(0.5);"-->
		</div>
				...
				<div class="row justify-content-center" style="background: #212121; color: white;">
					<div class="col-lg-3">
						<div class="box_contacts">
							<!--i class="ti-email"></i-->
							<img src="/template_15/img/mensajes.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-6">
						<div class="box_contacts">
							...
							<img src="/template_15/img/ubicacion.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-3">
						<div class="box_contacts">
							...
							<img src="/template_15/img/cel.png" width="55px" style="    padding-top: 0px;">
...
<!-- SPECIFIC CSS -->
    <link href="/template_15/css/contact.css" rel="stylesheet">
...
<script type="text/javascript" src="/template_15/js/contact.js"></script>
...
<script type="text/javascript">
	...
	function fill_place_information(){
		axios.get(`/api/template_15/place/${$(`select[name=place_id]`).val()}`)
		.then((response) => {
