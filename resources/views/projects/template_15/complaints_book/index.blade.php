  ...
  <div class="bg_gray py-5">
    <div class="container py-3">
      ...
      <div class="mb-4 text-justify" style="font-size: 16px; line-height: 1.2;">
        ¡Hola! Si tienes cualquier consulta o requieres una atención inmediata, te invitamos a usar nuestro canal de atención: central telefónica {{ $company_main->cel }} o enviar un correo electrónico a {{ $company_main->email }}. Gracias por ayudarnos a mejorar nuestro servicio.
      </div>
      <div class="font-weight-bold" style="font-size: 16px; line-height: 1.2;">
        Razón Social: {{ $company_main->business_company }}<br>
        RUC: {{ $company_main->ruc }}<br>
        Dirección: {{ $company_main->address }}
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <form id="claim_form">
        ...
        <div class="text-center">
          <a href="#" class="btn_1" id="claim__save"><b>ENVIAR INFORMACIÓN</b></a>
        </div>
      </form>
      <hr>
      <div class="mb-4 text-justify" style="font-size: 16px; line-height: 1.2;">
...
<script type="text/javascript" src="/template_15/js/claims.js"></script>
@stop
