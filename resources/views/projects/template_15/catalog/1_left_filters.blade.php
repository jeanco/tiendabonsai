<aside class="col-lg-3" id="sidebar_fixed">
	                ...
	                <div class="filter_col">
	                    ...
	                    <div class="filter_type version_2">
	                       <h3 style="font-size: 20px; padding-bottom: 15px;">
													 <a href="#filter_1" data-toggle="collapse" class="opened" style="color: #444; font-weight: 700;">Categorías</a>
												 </h3>
						...
						<div id="table_category-attribute">
							@include('template_15.catalog.attribute_filter')
						</div>
	                ...
	                <!--div class="banner_menu">
													<a href="">
														<img src="template_15/img/banner_horizontal.png" data-src="template_15/img/banner_horizontal.png" width="400" height="550" alt="" class="img-fluid lazy loaded" data-was-processed="true">
													</a>
												</div-->
