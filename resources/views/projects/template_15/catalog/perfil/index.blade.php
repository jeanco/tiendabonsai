	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
								...
								@endforeach
								{{--
	                            <div style="background-image: url(/template_15/img/products/shoes/1.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/2.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/3.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/4.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/5.jpg);" class="item-box"></div>
								<div style="background-image: url(/template_15/img/products/shoes/6.jpg);" class="item-box"></div>
								--}}
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
								...
								@endforeach
								{{--
	                            <div style="background-image: url(/template_15/img/products/shoes/1.jpg);" class="item active"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/2.jpg);" class="item"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/3.jpg);" class="item"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/4.jpg);" class="item"></div>
	                            <div style="background-image: url(/template_15/img/products/shoes/5.jpg);" class="item"></div>
								<div style="background-image: url(/template_15/img/products/shoes/6.jpg);" class="item"></div>
								--}}
	                        </div>
    ...
    margin-top: 5px;"><span style="font-weight: bold;" >Nota: </span>Puede seleccionar la sucursal que esta más cerca a su ubicación para visualizar el precio sugerido.</div>
	                    ...
	                    <div class="row">
							...
							<div class="tooltip" id="tooltip">
									<div class="thumb">
										<img src="/template_15/img/paso_checkout_catalogo.png" alt="">
									</div>
									<div class="info">
	                ...
	                <div class="product_actions">
	                    <ul>
	                        <li>
	                            <a href="https://api.whatsapp.com/send?phone={{ $company_main->cel }}&text=Mayor%20informaci%C3%B3n%20del%20producto" target="_blank"><img src="/template_15/img/whatsapp.png" class="button_select" width="40px" style=" background: white;"><span>Whatsapp</span></a>
	                        </li>
	                        <li>
	                            <a href="tel:{{ $company_main->cel }}" ><img src="/template_15/img/llamar.png" class="button_select" width="40px" style=" background: white; "><span style="padding-top: 9px;">Contactar</span></a>
	                        </li>
	                    </ul>
	                </div>
	                <!-- /product_actions -->
...
<!-- SPECIFIC CSS -->
    <link href="/template_15/css/product_page.css" rel="stylesheet">
    <link href="/template_15/css/tooltips.css" rel="stylesheet">

@stop
@section('plugins-js')

<!-- SPECIFIC SCRIPTS -->
    <script  src="/template_15/js/carousel_with_thumbs.js"></script>
    <script  src="/template_15/js/add_cart_with_number.js"></script>
	<script>
			...
			.addEventListener('click', function(e){
				...
				axios.get(`/api/template_15/product/${_productId}/is-there-stock?stock=1`)
					.then((response) => {
						...
						let _cart = {};
			      		_cart[_productId] = $("#quantity_1").val();
		...
		*/	
	    ...
	    $(`select[name="place_id"]`).on('change', function(e){
	        axios.post(`/api/template_15/set-place`, {
	...
	<script src="/template_15/js/tooltips.js"></script>
