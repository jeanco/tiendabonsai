<div class="container margin_60_35 header_desktop">
		...
		<ul id="banners_grid" class="clearfix">
			...
			<li>
				<a href="index.html#0" class="img_container">
					<img src="/template_15/img/banners_cat_placeholder.jpg" data-src="/template_15/img/banner_2.jpg" alt="" class="lazy">
			...
			<li>
				<a href="index.html#0" class="img_container">
					<img src="/template_15/img/banners_cat_placeholder.jpg" data-src="/template_15/img/banner_3.jpg" alt="" class="lazy">
					<div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
