		...
		<div class="container">
			{{--<div class="row">
				<div class="col-lg-3 col-md-6" style="">
					...
					<div class="collapse dont-collapse-sm links" id="collapse_1">
						<ul>
							...
							<li><a href="/metodos-de-entrega">Formas de Entrega</a></li>
				...
				<div class="col-lg-3 col-md-6">
					...
					<span style="color: white">Pago Seguro con izipay </span><br><br><img src="/template_15/img/izipay.png" height="40">
			...
			<div class="row add_bottom_25">
				...
				<div class="col-lg-12">
					<h2 style="color:white; text-align: center;">Para delivery llamar a <a href="tel:+51985854411">+51 985854411</a></h2>
				...
				<div class="col-lg-12">
					<ul class="additional_links">
						...
						<li>Desarrolado por Noveltie <span>© 2020 {{ $company_main->business_name }}</span></li>
					</ul>
				</div>
			</div>
		</div>
