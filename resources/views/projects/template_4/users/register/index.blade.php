...
@section('content')
	...
	<!-- /page_header -->
			...
			<div class="col-xl-5 col-lg-5 col-md-5">
				<div class="box_account">
					<h3 class="new_client">Nuevo Usuario</h3> <small class="float-right pt-2">* Campos obligatorios</small>
					...
					<div class="form_container">
						...
						<div class="form-group">
							<input type="password" class="form-control" name="password_confirmation" id="" value="" placeholder="Contraseña*">
...
<script src="/template_4/js/register_user.js"></script>
