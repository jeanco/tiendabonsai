					  ...
					  @if(!Auth::check())
						<li class="nav-item" id="pivot">
							...
							<div class="tooltip" id="tooltip">
									<div class="thumb">
										<img src="/template_5/img/paso_checkout.png" alt="">
									</div>
									<div class="info">
						...
						<div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
							<form id="checkout_form">
							  ...
							  <div class="form-group document-type-two">
								...
								<div class="form-group">
									<label class="document-type-one">DNI</label>
									<label class="document-type-two">RUC</label>
									<input type="text" value="{{ $identity_document }}" name="identity_document" class="form-control" placeholder="Ingrese el N° de Documento">
...
<!-- 							<div class="form-group">
							...
							<div class="row no-gutters">
								<div class="col-md-12 form-group" style="display: none;">
									...
									<div class="form-group">
									<input type="text" name="address__" class="form-control" value="Sucursal Tacna" disabled>
									</div>
								</div>
									...
									<div class="custom-select-form">
										<select class="wide add_bottom_15" name="country_id">
											...
											{{--@foreach($countries as $key => $country)
												...
												@endif
											@endforeach--}}
											<option value="1"selected=selected>Perú</option>
										</select>
									</div>
								</div>
							</div>
							...
							<div class="row no-gutters">
								<div class="col-md-12 form-group" style="margin-bottom: 0rem !important;">
									<label>Zonas</label>
									<div class="form-group ">
										<select class="wide add_bottom_15 form-control" name="district_id">
							...
							<!--div class="row no-gutters">
								<div class="col-md-12 form-group" style="margin-bottom: 0rem !important;">
									<label>Zonas</label>
									<div class="custom-select-form">
										<select class="wide add_bottom_15 form-control select2 select2-hidden-accessible " tabindex="-1" aria-hidden="true" name="district_id" id="district">
											<option value="0" selected>Distrito</option>
											<option value="1">Tacna</option>
											<option value="2">Alto de la Alianza</option>
											<option value="2">Ciudad Nueva</option>
							...
							<div class="form-group">
								...
								<hr>
								<p class="box_general" style="text-align: justify; padding: 10px; line-height: 15px;"><strong>Nota : </strong>  Toda entrega está sujeta a acceso y ubicación exacta del domicilio, para consultas sobre estado de entregas, confirmación o reprogramación de su despacho favor comuníquese al Teléfono   {{ $company_main->phone }}.</p>
							</div>
											...
											<div  class="method-payments">
												...
												@foreach ($payment_way['accounts'] as $account)
														...
														<li>
															...
															<label class="container_radio">{{ $account['name'] }} <a href="#0" class="info" data-toggle="modal" data-target="#payments_method_{{ $account['id'] }}"></a> <!--a href="#0" class="info" data-toggle="modal" data-target="#payments_method"></a-->
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="box_general summary">
						...
						<ul>
							...
							<li class="clearfix"><em><strong>Comisión de tarjeta 4.99%</strong></em> <span id="checkout_credit-card-comission">S/0.00</span></li>
						</ul>
	...
	<div class="modal fade" id="home_delivery" tabindex="-1" role="dialog" aria-labelledby="payments_method_title" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<p>ROESVIL, realiza despachos de Lunes a Sábado en el horario desde las 11:00 am hasta las 18:00 horas, aproximadamente, dependiendo del itinerario del transporte. No existen horarios específicos definidos previamente.<br><br>
Envió a domicilio tendrán un costo adicional mínimo de  S/ 6 soles y máximo de S/ 20 soles solo valido para la ciudad de Puno. (Sujeto a ubicación y accesibilidad del Transporte) .<br><br>
Calcular envío en otra ciudad, comuníquese: <br>Teléfono 051-355044 ó al Cel. 976188973.<br>
Tiempo de Entrega: Máximo 24 horas siguientes a la recepción y confirmación del pago.<br><br>
En aquellas ciudades, donde no hubiera tiendas Roesvil, los despachos se efectuarán previa coordinación con el cliente al momento de su compra.</p>
		  </div>
		</div>
	  </div>
	</div>
...
Solo válido para la ciudad de Puno.<br>(Sujeto a ubicación y accesibilidad del Transporte) .</p>
		  </div>
		</div>
	  </div>
	</div>
...
<script>
  ...
  //   	// Other address Panel
	...
	<script src="/template_4/js/orden_info.js"></script>
