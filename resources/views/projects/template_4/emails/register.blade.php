    ...
    <div style="margin: 50px 20px; width: 700px; font: 400 13.3333px Arial;">
          ...
          <div style="padding: 50px 0px; background: #fff8f8;">
                 <table width="100%">
                  ...
                  <tr>
                    <td width="19%"></td>
                    <td style="font-size: 16px; text-align: center;">Su registro se ha realizado exitosamente <br>el día {{$date_formatted}}.<br>
                ...
                <table width="100%" style="margin: 30px 0px;">
                  ...
                  <td width="50%" style="text-align: center; padding-top: 50px;"><a href="{{ $link }}"><button type="button" class="btn btn-cupon">Ingresar a mi Panel</button></a></td>
                  </tr>
                </table>
