...
@section('content')
		...
		<main class="bg_gray">
		<div class="top_banner general" style="height: 250px;">
			<div class="opacity-mask d-flex align-items-md-center" data-opacity-mask="rgbargba(35, 34, 34, 0.56)"
			style="background-image:  url({{ isset( $gallery_company[9]->resource) ? $gallery_company[9]->resource:  ''  }});
			...
			<!--img src="/template_4/img/top_about.jpg" class="img-fluid" alt="" style="filter: brightness(0.5);"-->
		</div>
		<!--/top_banner-->
...
<!-- SPECIFIC CSS -->
    <link href="/template_4/css/account.css" rel="stylesheet">
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<script src="/template_4/js/carousel-home.js"></script>
	{{--<script src="/template_4/js/subscriptions.js"></script>--}}
