<div class="row small-gutters">
	...
	<div class="col-6 col-md-3 owl-item-card">
		...
		<div class="grid_item ">
			...
			<a href="/catalogo/{{ $product['slug'] }}">
				<div class="font-weight-bold text-center" style="font-size: 15px; color: #2b2b2b;">{{ $product['name'] }}</div>
		...
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/2.jpg" alt="">
				</a>
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/3.jpg" alt="">
				</a>
				<div data-countdown="2020/03/15" class="countdown"></div>
			</figure>
			<a href="product-detail-1.html">
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/4.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/5.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/6.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/7.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
				<h3>Armor Air 98</h3>
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/8.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
				<h3>Armor Air 720</h3>
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_4/img/products/product_placeholder_square_medium.jpg" data-src="/template_4/img/products/shoes/9.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
				<h3>Armor 720</h3>
