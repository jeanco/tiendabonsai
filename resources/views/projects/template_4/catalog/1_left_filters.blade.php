<aside class="col-lg-3" id="sidebar_fixed">
	                ...
	                <div class="filter_col">
	                    ...
	                    <div class="filter_type version_2">
	                       <h5 style="padding-bottom: 20px;"><a href="#filter_1" data-toggle="collapse" class="opened" >Categorías</a></h5>
						...
						<div id="table_category-attribute">
							@include('template_4.catalog.attribute_filter')
						</div>
	                ...
	                <div class="banner_menu">
													<a href="">
														<img src="template_4/img/banner_horizontal.png" data-src="template_2/img/banner_horizontal.png" width="400" height="550" alt="" class="img-fluid lazy loaded" data-was-processed="true">
													</a>
												</div>
	            </aside>
