...
<header class="version_1 desktop_header" >
						...
						<ul class="top_tools">
							...
							<li>
								<div class="dropdown dropdown-cart">
									...
									<a href="/checkout" class="cart_bt" style="margin-top: 10px; color: var(--main-bg-color-primario);"><img src="/template_4/img/carrito_compras.png" width="35px" style="    padding-top: 0px;">
    ...
    color: white;">
								...
								<div class="dropdown-menu dropdown_sign_in" aria-labelledby="sign_in" >
							...
							{{--<li style="text-align: center;">
								<a href="{{ $company_main->facebook }}" target="_blank" style=" margin-top: 10px;"><img src="/template_4/img/facebook_icon.svg" style="width: 25px;     border-radius: 20px;"></a>
			...
			<div class="container">
				<div class="row small-gutters">
					...
					<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center justify-content-end text-center">
						...
						<a href="/suscripcion" ><img src="/template_4/img/catalogo.png" class="button_select" width="25px" style="padding: 2px;  margin: 10px;"></a>
						...
						<a href="{{ $company_main->whatsapp }}" target="_blank"><img src="/template_4/img/contacto.jpg" class="button_select" width="40px" style="padding: 2px; border-radius: 20px; margin: 10px;"></a>
