...
.headerstrip .headerstrip-content-background {
  ...
  background-image: url({{ isset( $secction_promotions[0]->image) ? $secction_promotions[0]->image:  ''  }});
  ...
  background-size: cover;
    ...
    .headerstrip .headerstrip-content-background {
      background-image: url({{ isset( $secction_promotions[0]->image_thumb) ? $secction_promotions[0]->image_thumb:  ''  }});
    }
...
@if(count($secction_promotions)>0 && $secction_promotions[0]->published == 1 )
