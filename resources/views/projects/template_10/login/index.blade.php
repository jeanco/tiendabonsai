...
<section class="contact-us" style="margin-bottom: 30px;">
    <div class="container py-5">
      ...
      <div class="row justify-content-center align-items-center" style="margin-bottom: 10px;">
        ...
        <div class="col-md-5"><input type="password" name="password" class="form-control" value="" placeholder="Escriba su Contraseña"></div>
      </div>
      <br>
      <center>
        <button type="submit" class="btn_1" style="width: 200px;">INICIAR SESIÓN</button>
        <hr>
        <a href="/registro" type="submit" class="btn btn-success" style="width: 200px;">Crear Nueva Cuenta</a>
      </center>
      {!! Form::close() !!}
    </div>
</section>
