		...
		<table class="table table-striped cart-list">
							...
							<tbody id="cart_tbody">
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_10/img/products/product_placeholder_square_small.jpg" data-src="/template_10/img/products/shoes/1.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_10/img/products/product_placeholder_square_small.jpg" data-src="/template_10/img/products/shoes/2.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_10/img/products/product_placeholder_square_small.jpg" data-src="/template_10/img/products/shoes/3.jpg" class="lazy" alt="Image">
										</div>
...
<!-- SPECIFIC CSS -->
    <link href="/template_10/css/cart.css" rel="stylesheet">
...
<script src="/template_10/js/checkout.js"></script>
