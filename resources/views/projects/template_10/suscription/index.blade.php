	...
	<!--/main-->
		...
		<div class="popup_content newsletter">
            ...
            <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center">
                <figure><img src="/template_10/img/newsletter_img.jpg" alt=""></figure>
            </div>
            <div class="col-md-7">
				<div class="content">
					<div class="wrapper">
					<img src="/template_10/img/logo_black.svg" alt="" width="100" height="35">
...
<!-- SPECIFIC CSS -->
    <link href="/template_10/css/account.css" rel="stylesheet">
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<!--script src="/template_10/js/carousel-home.js"></script-->
	<script src="/template_10/js/subscriptions.js"></script>
