...
<main class="bg_gray">
	...
	<div class="top_banner general banner_contact" style="height: 250px;">
			...
			<!--img src="/template_10/img/top_about.jpg" class="img-fluid" alt="" style="filter: brightness(0.5);"-->
		</div>
				...
				<div class="row justify-content-center" style="background: #212121; color: white;">
					<div class="col-lg-3">
						<div class="box_contacts">
							<!--i class="ti-email"></i-->
							<img src="/template_10/img/mensajes.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-6">
						<div class="box_contacts">
							...
							<img src="/template_10/img/ubicacion.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-3">
						<div class="box_contacts">
							...
							<img src="/template_10/img/cel.png" width="55px" style="    padding-top: 0px;">
...
<!-- SPECIFIC CSS -->
    <link href="/template_10/css/contact.css" rel="stylesheet">
...
<script type="text/javascript" src="/template_10/js/contact.js"></script>
...
<script type="text/javascript">
	...
	function fill_place_information(){
		axios.get(`/api/template_10/place/${$(`select[name=place_id]`).val()}`)
		.then((response) => {
