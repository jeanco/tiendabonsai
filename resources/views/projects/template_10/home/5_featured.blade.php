						...
						<div class="grid_item">
							...
							<div class="price_box text-center my-3">
								@if($product['promotion_available'])
									...
									<span class="new_price font-weight-bold" style="color: #d8203c; font-size: 22px;">$ {{ $product['price_promotion'] }}</span><br>
									<span class="font-weight-bold" style="color: #d8203c;">Ahorras {{ $product['promotion_discount'] }}</span>
								@else
									<span class="new_price font-weight-bold" style="color: #d8203c; font-size: 22px;">$ {{ $product['price'] }}</span>
								@endif
							</div>
							@endif
							<div class="">
