				...
				<div class="col-lg-9">
					...
					<!--div id="comments">
						...
						<ul>
							<li>
								<div class="avatar">
									<a href="blog-post.html#"><img src="/template_10/img/avatar1.jpg" alt="">
									</a>
								</div>
								...
								<ul class="replied-to">
									<li>
										<div class="avatar">
											<a href="blog-post.html#"><img src="/template_10/img/avatar2.jpg" alt="">
											</a>
										</div>
										<div class="comment_right clearfix">
											<div class="comment_info">
							...
							<li>
								<div class="avatar">
									<a href="blog-post.html#"><img src="/template_10/img/avatar3.jpg" alt="">
									</a>
								</div>
				...
				<aside class="col-lg-3">
					...
					<div class="widget">
						...
						<ul class="comments-list">
							...
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_10/img/blog-5.jpg" alt=""></a>
								</div>
							...
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_10/img/blog-6.jpg" alt=""></a>
								</div>
								<small>Category - 11.08.2016</small>
								<h3><a href="blog-post.html#" title="">Verear qualisque ex minimum...</a></h3>
							</li>
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_10/img/blog-4.jpg" alt=""></a>
								</div>
								<small>Category - 11.08.2016</small>
								<h3><a href="blog-post.html#" title="">Verear qualisque ex minimum...</a></h3>
							</li>
