<div class="row small-gutters">
    ...
    opacity: 1;">
			...
			<div class="price_box text-center my-3">
				@if($product['promotion_available'])
					...
					<span class="new_price font_bold" style="color: #d8203c; font-size: 24px;">${{ $product['price_promotion'] }}</span><br>
					<span class="font_bold" style="color: #d8203c;">Ahorras {{ $product['promotion_discount'] }}</span>
				@else
					<span class="new_price font_bold" style="color: #d8203c; font-size: 24px;">${{ $product['price'] }}</span>
				@endif
			</div>
			{{--@endif--}}
			<div class="">
	...
	<div class="col-12 col-md-12 text-center" >
		<img src="/template_10/img/no_result.png" style="padding: 20px; width: 120px;">
		<h1 style="font-weight: bold; color: var(--main-bg-color-primario);">NINGÚN RESULTADO</h1>
		<h5>Su búsqueda de "Productos" no tuvo resultados.</h5>
