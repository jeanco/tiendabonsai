...
<main>
	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
								...
								@endforeach
								{{--
	                            <div style="background-image: url(/template_10/img/products/shoes/1.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/2.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/3.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/4.jpg);" class="item-box"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/5.jpg);" class="item-box"></div>
								<div style="background-image: url(/template_10/img/products/shoes/6.jpg);" class="item-box"></div>
								--}}
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
								...
								@endforeach
								{{--
	                            <div style="background-image: url(/template_10/img/products/shoes/1.jpg);" class="item active"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/2.jpg);" class="item"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/3.jpg);" class="item"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/4.jpg);" class="item"></div>
	                            <div style="background-image: url(/template_10/img/products/shoes/5.jpg);" class="item"></div>
								<div style="background-image: url(/template_10/img/products/shoes/6.jpg);" class="item"></div>
								--}}
	                        </div>
    ...
    margin-top: 5px;"><span style="font-weight: bold;" >Nota: </span>Puede seleccionar la sucursal que esta más cerca a su ubicación para visualizar el precio sugerido.</div>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-lg-12 col-md-12">
							<div class=""><a   href="/checkout" class="btn_1 {{ $product['stock'] == 0 ? 'disabled' : '' }}"  style="width: 100%; margin: 10px 0 10px 0;">Pagar Ahora</a></div>
	                        </div>
							...
							<div class="tooltip" id="tooltip">
									<div class="thumb">
										<img src="/template_10/img/paso_checkout_catalogo.png" alt="">
									</div>
									<div class="info">
	                ...
	                <div class="product_actions">
	                    <ul>
	                        <li>
	                            <a href="https://api.whatsapp.com/send?phone={{ $company_main->cel }}&text=Mayor%20informaci%C3%B3n%20del%20producto" target="_blank"><img src="/template_10/img/whatsapp.png" class="button_select" width="40px" style=" background: white;"><span>Whatsapp</span></a>
	                        </li>
	                        <li>
	                            <a href="tel:{{ $company_main->cel }}" ><img src="/template_10/img/llamar.png" class="button_select" width="40px" style=" background: white; "><span style="padding-top: 9px;">Contactar</span></a>
	                        </li>
	                    </ul>
	                </div>
	                <!-- /product_actions -->
...
<!-- SPECIFIC CSS -->
    <link href="/template_10/css/product_page.css" rel="stylesheet">
    <link href="/template_10/css/tooltips.css" rel="stylesheet">

@stop
@section('plugins-js')

<!-- SPECIFIC SCRIPTS -->
    <script  src="/template_10/js/carousel_with_thumbs.js"></script>
    <script  src="/template_10/js/add_cart_with_number.js"></script>
	<script>
		...
		*/	
	    ...
	    $(`select[name="place_id"]`).on('change', function(e){
	        axios.post(`/api/template_10/set-place`, {
	...
	<script src="/template_10/js/tooltips.js"></script>
