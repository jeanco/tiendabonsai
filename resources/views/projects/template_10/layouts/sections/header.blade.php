...
<header class="version_1 header_desktop">
    ...
    padding: 5px 0px 5px 0px;"></a>
					...
					<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center justify-content-end text-center">
						...
						<a href="https://hosting.wialon.com/" target="_blank" class="btn_3 header_desktop" style="  margin: 0 15px 0 10px;  background: var(--main-bg-color-secundario); color: black !important;">Plataforma Web</a>
						...
						<a href="{{ $company_main->whatsapp }}" target="_blank" class="header_desktop"><img src="/template_10/img/whatsapp.png" class="button_select" width="40px" style="padding: 2px; border-radius: 20px; margin: 10px;"></a>
					</div>
				...
				<div class="row small-gutters">
					...
					<div class="col-xl-6 col-lg-7 col-md-6 d-none d-md-block">
						<div class="custom-search-input" style="margin-top: 10px;">
							<input type="text" placeholder="Buscar Productos" class="input-large focus form-control input-search-product">
							<button type="submit" style="margin-top: 10px;" id="search_button"><i class="header-icon_search_custom"></i></button>
						</div>
					</div>
						...
						<ul class="top_tools">
							<li>
								<div class="dropdown dropdown-cart">
									<a href="/checkout" class="cart_bt" style="padding-top: 5px;"> <strong id="cart-header_quantity" style="background: #252525;
    padding: 1px 2px;
    border-radius: 7px; 
    position: absolute;
    right: -10px;
    top: 25px;">0</strong></a>
    						...
    						<div class="dropdown-menu">
										<div style="overflow-y: scroll; height: 230px; overflow-x: hidden;">
											<ul id="cart_products">
											<li>
												<a href="product-detail-1.html">
													<figure><img src="/template_4/img/products/product_placeholder_square_small.jpg" data-src="/template_4/img/products/shoes/thumb/1.jpg" alt="" width="50" height="50" class="lazy"></figure>
											...
											<li>
												<a href="product-detail-1.html">
													<figure><img src="/template_4/img/products/product_placeholder_square_small.jpg" data-src="/template_4/img/products/shoes/thumb/2.jpg" alt="" width="50" height="50" class="lazy"></figure>
