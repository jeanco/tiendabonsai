<header class="version_1 header_movil">
   ...
   <div class="main_nav Sticky">
      <div class="container">
         <div class="row small-gutters">
            ...
            <div class="col-xl-3 col-lg-2 col-md-3">
               <ul class="top_tools">
               	  <li>
               	  	<a href="{{ $company_main->whatsapp }}" target="_blank" class="header_desktop"><img src="/template_10/img/whatsapp.png" class="button_select" width="40px" style="padding: 4px;  "></a>
               	  </li>	
                  <li>
                              ...
                              <ul id="cart_products">
                                 <!--li>
                                    <a href="product-detail-1.html">
                                    	<figure><img src="/template_10/img/products/product_placeholder_square_small.jpg" data-src="/template_10/img/products/shoes/thumb/1.jpg" alt="" width="50" height="50" class="lazy"></figure>
                                    ...
                                    <li>
                                    <a href="product-detail-1.html">
                                    	<figure><img src="/template_10/img/products/product_placeholder_square_small.jpg" data-src="/template_10/img/products/shoes/thumb/2.jpg" alt="" width="50" height="50" class="lazy"></figure>
      ...
      <div class="search_mob_wp">
         <input type="text" class="form-control input-search-product" id="value_search" placeholder="Buscar Productos">
