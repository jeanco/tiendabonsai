				...
				<div class="col-lg-9">
					...
					<div id="comments">
						...
						<ul>
							<!-- Comentario 1 -->
							<li>
									<div class="avatar"><a href="javascript:void(0);"><img src="/template_7/img/avatar1.jpg" alt=""></a></div>
									...
									<ul class="replied-to">
												<!-- Respuesta 1 -->
												<li>
													<div class="avatar"><a href="javascript:void(0)"><img src="/template_7/img/avatar2.jpg" alt=""></a></div>
													<div class="comment_right clearfix">
														<div class="comment_info">
							...
							<li>
								<div class="avatar">
									<a href="javascript:void(0);"><img src="/template_7/img/avatar1.jpg" alt=""></a>
								</div>
								<div class="comment_right clearfix">
									<div class="comment_info">
										<a href="javascript:void(0);">Jean Carlos Ancahpuri</a><span>|</span>22/06/2020<span>|</span>
				...
				<aside class="col-lg-3">
					...
					<div class="widget">
						...
						<ul class="comments-list">
							...
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_7/img/blog-5.jpg" alt=""></a>
								</div>
							...
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_7/img/blog-6.jpg" alt=""></a>
								</div>
								<small>Category - 11.08.2016</small>
								<h3><a href="blog-post.html#" title="">Verear qualisque ex minimum...</a></h3>
							</li>
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_7/img/blog-4.jpg" alt=""></a>
								</div>
								<small>Category - 11.08.2016</small>
								<h3><a href="blog-post.html#" title="">Verear qualisque ex minimum...</a></h3>
							</li>
...
<!-- SPECIFIC CSS -->
    <link href="/template_7/css/blog.css" rel="stylesheet">
