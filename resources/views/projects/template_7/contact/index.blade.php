...
<main class="bg_gray">
	...
	<div class="top_banner general banner_contact" style="height: 250px;">
			<div class="opacity-mask banner_contact d-flex align-items-md-center"  data-opacity-mask="rgba(0, 0, 0, 0.1)" style="background:  url(/template_3/img/background_suscription.png); background-size: cover; height: 250px;">
				...
				<div class="row justify-content-center" style="background: #212121; color: white;">
					<div class="col-lg-3">
						<div class="box_contacts">
							<!--i class="ti-email"></i-->
							<img src="/template_7/img/mensajes.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-6">
						<div class="box_contacts">
							...
							<img src="/template_7/img/ubicacion.png" width="55px" style="    padding-top: 0px;">
					...
					<div class="col-lg-3">
						<div class="box_contacts">
							...
							<img src="/template_7/img/cel.png" width="55px" style="    padding-top: 0px;">
...
<!-- SPECIFIC CSS -->
    <link href="/template_7/css/contact.css" rel="stylesheet">
