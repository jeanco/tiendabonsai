				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="collapse dont-collapse-sm" id="collapse_4">
						<div class="follow_us mt-3">
							<ul>
								<li><a href="{{ $company_main->twitter }}" target="_blank" ><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/template_7/img/twitter_icon.svg" alt="" class="lazy"></a></li>
								<li><a href="{{ $company_main->facebook }}" target="_blank" ><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/template_7/img/facebook_icon.svg" alt="" class="lazy"></a></li>
								<li><a href="{{ $company_main->instagram }}" target="_blank" ><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/template_7/img/instagram_icon.svg" alt="" class="lazy"></a></li>
								<li><a href="{{ $company_main->youtube }}" target="_blank" ><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="/template_7/img/youtube_icon.svg" alt="" class="lazy"></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row add_bottom_25">
				<div class="col-lg-6">
					<ul class="footer-selector clearfix">
						<li><img src="/template_7/img/tarjetas.png" data-src="/template_7/img/tarjetas.png" alt="" height="35" class="lazy"></li>
					</ul>
				</div>
				<div class="col-lg-6">
