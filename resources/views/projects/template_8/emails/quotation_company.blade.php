  ...
  <body>
    <div style="margin: 50px 20px; width: 700px; font: 400 13.3333px Arial;">
          ...
          <div style="padding: 50px 0px; background: #fff8f8;">
                 <table width="100%">
                  <tr><td colspan="3" style="text-align: center; font-size: 18px;"><h3>¡Buen día!</h3></td></tr>
                  <tr>
                    <td width="19%"></td>
                    <td style="font-size: 16px; text-align: center;">Se ha realizado una cotización <br>el día {{$date_formatted}}.<br>
                      <p>Comuníquese pronto.</p></td>
                    <td width="19%"></td>
                  </tr>
                </table>
