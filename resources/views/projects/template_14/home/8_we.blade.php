<div class="container margin_60_35 add_bottom_30">
				<div class="main_title">
					<h2>Sobre  {{$company_main->business_name}}</h2>
				...
				<div class="row justify-content-center align-items-center">
					<div class="col-lg-5">
						...
						<a class="btn_1" href="/nosotros"  role="button">Ver más</a>
					</div>
				...
				<!--div class="row justify-content-center align-items-center">
					<div class="col-lg-5 pr-lg-5 text-center d-none d-lg-block">
							<img src="/template_14/img/about_2.svg" alt="" class="img-fluid" width="350" height="268">
					</div>
					<div class="col-lg-5">
						<div class="box_about">
							<h2>Top Brands</h2>
							...
							<img src="/template_14/img/arrow_about.png" alt="" class="arrow_2">
						</div>
					</div>
				</div>
				...
				<div class="row justify-content-center align-items-center ">
					...
					<div class="col-lg-5 pl-lg-5 text-center d-none d-lg-block">
							<img src="/template_14/img/about_3.svg" alt="" class="img-fluid" width="350" height="316">
					</div>
				</div-->
