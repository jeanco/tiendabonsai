    ...
    <div style="margin: 50px 20px; width: 700px; font: 400 13.3333px Arial;">
          ...
          <div style="padding: 50px 0px; background: #fff8f8;">
                 <table width="100%">
                  ...
                  <tr>
                    <td width="19%"></td>
                    <td style="font-size: 16px; text-align: center;">Su registro se ha realizado exitosamente <br>el día {{$date_formatted}}.</td>
                    <td width="19%"></td>
                  </tr>
                </table>
                ...
                <table width="100%" style="margin: 30px 0px;">
                  <td style="font-size: 16px; text-align: center;"><br>
                      <p>Recuerde que puede ingresar con su Usuario y Contraseña </p> <br></td>
                	<tr>
