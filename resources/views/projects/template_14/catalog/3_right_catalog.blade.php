<div class="row small-gutters">
		...
		<div class="grid_item ">
			...
			@php
				...
				$brand = 'Otros';
						...
						if(count($product['brands_perfil_product_template_14'])){
						$brand = $product['brands_perfil_product_template_14'][0]['name'];
						}	
	...
	<div class="col-6 col-md-4">
		<div class="grid_item">
			...
			<figure>
				<a href="product-detail-1.html">
					<img class="img-fluid lazy" src="/template_14/img/products/product_placeholder_square_medium.jpg" data-src="/template_14/img/products/shoes/9.jpg" alt="">
				</a>
			</figure>
			<a href="product-detail-1.html">
				<h3>Armor 720</h3>
