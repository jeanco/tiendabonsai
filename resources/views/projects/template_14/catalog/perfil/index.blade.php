...
<main>
	                ...
	                <div class="prod_info">
	                   ...
	                   {{--<div class="row">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-lg-6 col-md-6">
							{{--<div class="btn_add_to_cartx"><a href="/checkout/info" data-index="{{ $product['id'] }}" class="btn_1 {{ $product['stock'] == 0 ? 'disabled' : '' }}" id="buy_now" style="width: 100%; margin: 10px 0 10px 0;  padding: 10px 5px !important;">Comprar Ahora</a></div> --}}

							<div class="btn_add_to_cartx"><a href="/checkout/info" data-index="{{ $product['id'] }}" class="btn_1 {{ $product['stock'] == 0 ? 'disabled' : '' }}"  style="width: 100%; margin: 10px 0 10px 0;  padding: 10px 5px !important;">Comprar Ahora</a></div> 
	                        </div>
	                        @if( $product['pdf'])
	                        <div class="col-lg-12 col-md-12">
    ...
    margin-top: 10px;">Stock No Disponible</span>
	                ...
	                {{--<div class="product_actions">
	                    <ul>
	                        <li>
	                            <a href="https://api.whatsapp.com/send?phone={{ $company_main->cel }}&text=Mayor%20informaci%C3%B3n%20del%20producto" target="_blank"><img src="/template_14/img/whatsapp.png" class="button_select" width="45px" style="padding: 1px; background: white;"><span>Whatsapp</span></a>
	                        </li>
	                        <li>
	                            <a href="tel:{{ $company_main->cel }}" ><img src="/template_14/img/contacto.jpg" class="button_select" width="45px" style=""><span style="">Contactar</span></a>
	                        </li>
	                    </ul>
	                </div>--}}
	                <!-- /product_actions -->
    ...
    margin-top: 10px;">Stock No Disponible</span>
	                ...
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_14/img/products/product_placeholder_square_medium.jpg" data-src="/template_14/img/products/shoes/5.jpg" alt="">
	                        </a>
	                    </figure>
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_14/img/products/product_placeholder_square_medium.jpg" data-src="/template_14/img/products/shoes/8.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="product-detail-1.html">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_14/img/products/product_placeholder_square_medium.jpg" data-src="/template_14/img/products/shoes/2.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="product-detail-1.html">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="product-detail-1.html">
	                            <img class="owl-lazy" src="/template_14/img/products/product_placeholder_square_medium.jpg" data-src="/template_14/img/products/shoes/3.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="product-detail-1.html">
...
<!-- SPECIFIC CSS -->
    <link href="/template_14/css/product_page.css" rel="stylesheet">
...
<!-- SPECIFIC SCRIPTS -->
    <script  src="/template_14/js/carousel_with_thumbs.js"></script>
    <script  src="/template_14/js/add_cart_with_number.js"></script>
	<script>
		...
		document.querySelector(`#buy_now`)
			.addEventListener('click', function(e){
				...
				axios.get(`/api/template_14/product/${_productId}/is-there-stock?stock=1`)
					.then((response) => {
