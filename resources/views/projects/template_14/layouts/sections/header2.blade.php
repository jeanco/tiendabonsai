<header class="version_1 movil_header">
		...
		<div class="main_nav Sticky" style="background-color: #fff;">
			<div class="container">
				<div class="row small-gutters" style="text-align: center; padding-bottom: 10px;">
					<!-- ////////////////// -->
					<div class="col-md-4">
						...
						<ul class="top_tools">
							...
							<li style="margin-right: 15px;">
								<div class="dropdown dropdown-cart">
									...
									<a href="/checkout" class="cart_bt" style="color: var(--main-bg-color-primario);"><img src="/template_14/img/carrito_compras.png" width="30px" style="    padding-top: 0px;"> <strong id="cart-header_quantity_mobil" style="top: 16px; right: -13px;">0</strong></a>
			...
			<div class="search_mob_wp">
				<input type="text" class="form-control" id="value_search_mobile_" placeholder="Buscar más productos">
				<input type="submit"  id="search_product_mobile_" class="btn_1 full-width" value="Buscar" style="background: var(--main-bg-color-secundario);">
			</div>
