...
<head>
   ...
   <!-- GOOGLE WEB FONT -->
    ...
    <!-- BASE CSS -->
    <link href="/template_14/css/bootstrap.custom.min.css" rel="stylesheet">
...
@media (min-width: 768px) {
    ...
    <link href="/template_14/css/style.css" rel="stylesheet">

	<!-- SPECIFIC CSS -->
    <link href="/template_14/css/home_1.css" rel="stylesheet">
    <link href="/template_14/css/new_style.css" rel="stylesheet">
...
<!--body class="scroll_edit"-->
	...
	<div id="page">
     ...
     @include('template_14.layouts.sections.header_top')
	 @include('template_14.layouts.sections.header')
     @include('template_14.layouts.sections.header2')
	...
	<!-- /main -->
	  ...
	  <!--Footer section -->
        @include('template_14.layouts.sections.footer')

	</div>



    {{--<div class="popup_wrapper" id="subscription_modal_">
       <div class="popup_content newsletter ">
            <span class="popup_close" id="">Cerrar</span>
            ...
            <div class="row no-gutters">
                <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                    ...
                    <div class="content">
                        <div class="wrapper">
                        <img src="/template_14/img/notification_email.png" alt="" width="50%">
                ...
                <div class="col-md-12">
                    <div class="content">
                        ...
                        <h3 style="margin-top: 5px">Te damos la bienvenida a la familia {{$company_main->business_name}}</h3>
                        <p>Espacio en el que recibirás ofertas, descuentos y noticias.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="popup_content newsletter">
            ...
            <div class="col-md-7">
                <div class="content">
                    <div class="wrapper">
                    <img src="{{ $company_main->logotype }}" alt="" height="35">
                    <h3>Suscríbete para recibir más novedades</h3>
                    <p>Ingresa tus datos para conocer nuestras ofertas, descuentos y noticias.</p>
                     <form action="modal-newsletter.html#">
                        <div class="form-group">
                            <input type="text" class="form-control" id="subscription_name" placeholder="Ingresa tu Nombre ">
                            <div class="mensaje-error" id="subscription-error-name"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Ingresa tu Apellido" id="subscription_lastname">
	...
	<!-- COMMON SCRIPTS -->
    <script src="/template_14/js/common_scripts.min.js"></script>
    ...
    <script src="/template_14/js/main.js"></script>
    <script src="/admin/plugins/axios/axios.js"></script>


	<!-- SPECIFIC SCRIPTS -->
    <script src="/template_14/js/carousel-home.min.js"></script>

  	<script src="/template_14/js/custom-app.js"></script>
  	<script src="/template_14/js/fill_cart.js"></script>
    <script src="/template_14/js/add_to_cart.js"></script>
    ...
    <script>
        ...
        $(`#button_enviar`).on('click', function(e){
            var value_search = $("#search_product").val();
            window.location.replace(`/catalogo?q=${value_search}`);
        });
        $(`#search_product_mobile`).on('click', function(e){
            value = $("#value_search_mobile").val()
            window.location.replace(`/catalogo?q=${value}`);
        });
        $(`#search_product_mobile_`).on('click', function(e){
            value = $("#value_search_mobile_").val()
            window.location.replace(`/catalogo?q=${value}`);
        });
    </script>
   ...
   /* $(window).on('load', function() {
    ...
    {{-- Suscriptions  --}}
    <script type="text/javascript" src="{{ URL::asset('template_14/js/subscriptions.js') }}"></script>
