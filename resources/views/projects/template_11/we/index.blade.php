...
<main class="bg_gray">
		...
		@if(isset($gallery_company[0]->resource))
		...
		<!--/top_banner-->
			<div class="container margin_60_35 add_bottom_30">
				...
				<!--div class="row justify-content-center align-items-center">
					<div class="col-lg-5 pr-lg-5 text-center d-none d-lg-block">
							<img src="/template_11/img/about_2.svg" alt="" class="img-fluid" width="350" height="268">
					</div>
					<div class="col-lg-5">
						<div class="box_about">
							<h2>Top Brands</h2>
							...
							<img src="/template_11/img/arrow_about.png" alt="" class="arrow_2">
						</div>
					</div>
				</div>
				...
				<div class="row justify-content-center align-items-center ">
					...
					<div class="col-lg-5 pl-lg-5 text-center d-none d-lg-block">
							<img src="/template_11/img/about_3.svg" alt="" class="img-fluid" width="350" height="316">
					</div>
				</div-->
			...
			<div class="owl-carousel owl-theme carousel_centered">
				...
				<!--div class="item">
					<a href="#">
						...
						</div><img src="/template_11/img/staff/4_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_11/img/staff/5_carousel.jpg" alt="">
					</a>
				</div-->
			</div>--}}
			...
			@if(isset($gallery_company[1]->resource))
			<div id="carousel-home">
			<div class="owl-carousel owl-theme">
				<div class="owl-slide cover" style="background-image: url({{ isset( $gallery_company[1]->resource) ? $gallery_company[1]->resource:  ''  }});">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url({{ isset( $gallery_company[2]->resource) ? $gallery_company[2]->resource:  ''  }});">
					<div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
						<div class="container">
							<div class="row justify-content-center justify-content-md-start">
								<div class="col-lg-6 static">
		...
		<div class="container margin_60_35 add_bottom_30">
			...
			@if($company_main->mission)
				<div class="row justify-content-center align-items-center">
					...
					<div class="col-lg-5 pl-lg-5 text-center d-none d-lg-block">
							<img src="{{ isset( $gallery_company[3]->resource) ? $gallery_company[3]->resource:  ''  }}" alt="" class="img-fluid " style="border-radius: 25px;" width="350" height="268">
					</div>
				</div>
			@endif
			@if($company_main->vision)
				<div class="row justify-content-center align-items-center">
					<div class="col-lg-5 pr-lg-5 text-center d-none d-lg-block">
							<img src="{{ isset( $gallery_company[4]->resource) ? $gallery_company[4]->resource:  ''  }}" alt="" class="img-fluid " style="border-radius: 25px;" width="350" height="268">
					</div>
					<div class="col-lg-5">
						<div class="box_about">
			...
			<div class="owl-carousel owl-theme carousel_centered">
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_11/img/staff/1_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_11/img/staff/2_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
						...
						</div><img src="/template_11/img/staff/3_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#">
