...
@section('content')
		...
		<main class="bg_gray">
		<div class="top_banner general top_banner_suscription" style="height: 570px;">
			<div class="opacity-mask  banner-suscription d-flex align-items-md-center" data-opacity-mask="rgba(0, 0, 0, 0.1)" style="background:  url('/template_11/img/portada_sus.jpg'); background-size: cover;">
				<div class="container">
			...
			<!--img src="/template_11/img/top_about.jpg" class="img-fluid" alt="" style="filter: brightness(0.5);"-->
		</div>
		<!--/top_banner-->
	...
	<!--/main-->
		...
		<div class="popup_content newsletter">
            ...
            <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center">
                <figure><img src="/template_11/img/newsletter_img.jpg" alt=""></figure>
            </div>
            <div class="col-md-7">
				<div class="content">
					<div class="wrapper">
					<img src="/template_11/img/logo_black.svg" alt="" width="100" height="35">
...
<!-- SPECIFIC CSS -->
    <link href="/template_11/css/account.css" rel="stylesheet">
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<!--script src="/template_11/js/carousel-home.js"></script-->
	<script src="/template_11/js/subscriptions.js"></script>
