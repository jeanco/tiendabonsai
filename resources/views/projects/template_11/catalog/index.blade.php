...
<main>
	  <div class="container ">
	      <div class="row pt-4">
	        	@include('template_11.catalog.1_left_filters')
	            <!-- /col -->
	            <div class="col-lg-9 pt-0 margin_30">
		                    ...
		                    <ul class="m-0" id="breadcrumbs-parent">
								...
								<li><a class="a-breadcrumbs" id="breadcrumb-subcategory" href=""></a></li> -->
										...
										<div class="mb-2 col-auto text-right catalog_sm_none">
					...
					<!-- /toolbox -->
									<div id="table_data_product">
										@include('template_11.catalog.3_right_catalog')
									</div>
	            </div>
	            <!-- /col -->
	      </div>
...
<!-- SPECIFIC CSS -->
    <link href="/template_11/css/listing.css" rel="stylesheet">
@stop
@section('plugins-js')

<!-- SPECIFIC SCRIPTS -->
	<script src="/template_11/js/catalog.js"></script>
	<script src="/template_11/js/sticky_sidebar.min.js"></script>
	<script src="/template_11/js/specific_listing.js"></script>
