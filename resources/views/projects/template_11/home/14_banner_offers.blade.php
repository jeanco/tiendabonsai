  ...
  @for($i=0;$i<$catalog_rows; $i++)
    @if($i%2 == 0)
      <div class="row mb-4">
        ...
        <div class="col-md-4">
          <a href="{{ $catalogs[$index+1]->link }}" target="_blank"><img src="{{ $catalogs[$index+1]->image_desktop }}" alt="" style="width: 100%; min-height: 400px;"></a>
        </div>
        @endif
        @php
          $index += 2;
    ...
    <div class="row">
      ...
      @if(isset($catalogs[$index+1]))
      <div class="col-md-8">
        <a href="{{ $catalogs[$index+1]->link }}" target="_blank" class="sm_none"><img src="{{ $catalogs[$index+1]->image_desktop }}" alt="" style="width: 100%; min-height: 400px;"></a>
        <a href="{{ $catalogs[$index+1]->link }}" target="_blank" class="md_none"><img src="{{ $catalogs[$index+1]->image_movil }}" alt="" style="width: 100%; min-height: 400px;"></a>
      </div>
      @endif
        @php
          $index += 2;
