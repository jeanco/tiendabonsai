		...
		<div class="row">
			<div class="col-md-4" style="border-right: 1px solid #ddd;">
				<div class="row align-items-center">
					<div class="col-3">
						<img src="/template_11/img/icon_1.png" alt="" style="width: 100%;">
					</div>
					<div class="col-9">
			...
			<div class="col-md-4" style="border-right: 1px solid #ddd;">
				<div class="row align-items-center">
					<div class="col-3">
						<img src="/template_11/img/icon_2.png" alt="" style="width: 100%;">
					</div>
					<div class="col-9">
			...
			<div class="col-md-4">
				<div class="row align-items-center">
					<div class="col-3">
						<img src="/template_11/img/icon_3.png" alt="" style="width: 100%;">
					</div>
					<div class="col-9">
...
<div style="background-color: var(--main-bg-color-terciario);">
	<div class="container margin_60_35" >
		<div class="text-white mb-2">
			<img src="/template_11/img/icon_6_.png" alt="" width="35px">&nbsp;
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6" style="color: #000;">
					...
					<div class="py-3"><a href="{{ $company_main->whatsapp }}" target="_blank" class="btn btn_footer_1"><img src="\template_11\img\whatsapp_ico.png" alt="" style="height: 28px;">{{ $company_main->cel }}</a></div>
