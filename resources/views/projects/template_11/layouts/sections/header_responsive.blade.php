   ...
   <div class="main_nav Sticky">
      <div class="container">
         <div class="row small-gutters">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 d-none">
            ...
            <div class="col-xl-6 col-lg-7 col-md-6 d-none">
            ...
            <div class="col-12">
               <ul class="top_tools">
               	  <li style="display: none;">
               	  	<a href="{{ $company_main->whatsapp }}" target="_blank" class="header_desktop"><img src="/template_11/img/whatsapp.png" class="button_select" width="40px" style="padding: 4px;  "></a>
               	  </li>
                  <li>
                     <div class="dropdown dropdown-cart">
                        <a href="/checkout" style="padding-top: 5px;">
                          <img src="/template_11/img/icon_5_.png" width="30px">
                  ...
                  @endif
                  <li>
    								<div class="row align-items-center mx-0 mrt_money">
    									<div class="dropdown money_select">
    									  <button type="button" class="btn btn-link dropdown-toggle" data-toggle="dropdown">
    									    <span>{{ $current_currency[0]['symbol'] }}</span><span class="sm_none_symbol">&nbsp;{{ $current_currency[0]['code'] }}</span>
    									  </button>
    									  <div class="dropdown-menu">
