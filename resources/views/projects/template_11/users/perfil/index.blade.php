        ...
        <div class="col-md-9">
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="data">
              @include('template_11.users.perfil.1_data')
            </div>
            <div role="tabpanel" class="tab-pane" id="coupons">
              {{-- @include('template_11.users.perfil.2_coupons') --}}
              Codigo comentado, revisar vista
            </div>
            <div role="tabpanel" class="tab-pane" id="orders">
               @include('template_11.users.perfil.3_orders')
            </div>
            <div role="tabpanel" class="tab-pane" id="logistic">
              @include('template_11.users.perfil.4_logistics')
            </div>
          </div>
        </div>
      </div>
...
@stop
@section('plugins-css')
<link href="/template_11/css/error_track.css" rel="stylesheet">
@stop
@section('plugins-js')
<script src="/template_11/js/profile.js"></script>
<script src="/template_11/js/logistics.js"></script>
<script>
