...
<html>
  <head>
    ...
    <title>Orden de Pedido Cliente</title>
    <!-- Favicons-->
        ...
        <tbody>
          ...
          <tr>
            ...
            @if($product['has_hidden_price'])
              <td class="pdf-table">{{ $product['message_about_price'] }}</td>
              <td class="pdf-table">{{ $t['symbol'] }}{{ $product['discount'] }}</td>
              <td class="pdf-table" style="color: #00549d; font-weight: 700;">{{ $product['message_about_price'] }}</td>
            @else
...
<!--           <tr>
         ...
         <tfoot>
           <tr>
            ...
            @else
              <td class="pdf-foot-table">{{ $company_main['checkout_message'] }}</td>
            @endif
          </tr>
          {{--<tr>
