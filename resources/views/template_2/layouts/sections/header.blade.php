...
<header class="version_1 header_desktop">
    ...
    margin-left: 40px;
    margin-right: auto;">
							<a href="/"><img src="{{ $company_main->logotype_white }}" alt=""  style="height:72px;  padding: 5px 0px 5px 0px;"></a>
						</div>
					</div>
					...
					<div class="col-xl-8 col-lg-7 col-md-6 d-none d-md-block" style="text-align: center;">
						<div class="main-menu">
							<div id="header_menu">
								<a href="/"><img src="{{ $company_main->logotype }}" alt="" width="100" style="height:60px !important;"></a>
								<a href="#" class="open_close" id="close_in"><i class="ti-close"></i></a>
							...
							<ul>
								...
								<!--li >
									<a  class="header_cotiza"   href="/cotizar" style="color: #202020; font-weight:bold;">Cotiza</a>
								</li-->
					...
					{{--<div class="col-xl-2 col-lg-7 col-md-6 d-none d-md-block section_menu_search" style="text-align: center;">
						...
						<ul class="top_tools">
							<li>
								...
								<div class="dropdown dropdown-cart">
									...
									{{--<a href="/checkout" class="" style="padding-top: 10px;"><img src="{{ $company_main->icon_car }}" width="40px" style="    padding-top: 0px;"> <strong id="cart-header_quantity" style="background: #252525;
    padding: 1px 2px;
    border-radius: 7px;
    right: 0px; top: 50px;">0</strong></a> --}}
									<div class="dropdown-menu" >
										...
										<div class="total_drop">
											...
											<a href="/checkout" class="btn_1 outline">Ver {{ $company_main->icon_car_title }}</a>
											<a href="/checkout/info" class="btn_1">Realizar {{$company_main->online_payment ? 'la Compra' : 'el Pedido'}}</a>
										</div>
									</div>
								</div>
								<!-- /dropdown-cart-->
							...
							<li>
								...
								<a href="javascript:void(0);"  style="padding-top: 15px;" class="  btn_search_mob"><span>Buscar</span></a>
							</li>
			...
			<div class="search_mob_wp search_mob_wp_deskopt">
				<input type="text" class="form-control text-center" id="value_search" placeholder="Buscar más productos">
