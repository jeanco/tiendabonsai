...
@section('content')
		...
		<div class="top_banner general top_banner_suscription">
			@if($company_main->banner_suscription)
			<div class="opacity-mask  banner-suscription d-flex align-items-md-center" data-opacity-mask="rgba(0, 0, 0, 0.1)" style="	background: rgb(0,0,0);
background: linear-gradient(90deg, rgba(0,0,0,0.9164040616246498) 0%, rgba(0,0,0,0.6278886554621849) 35%, rgba(0,212,255,0) 100%),
url('{{ isset( $gallery_company[3]->resource) ? $gallery_company[3]->resource:  ''  }}');

			background-size: cover;">
				@else
			<div class="opacity-mask  banner-suscription d-flex align-items-md-center" style="background:  #0e0e0e; background-size: cover;">
				@endif
					 		...
					 		<div class="col-md-3">
					 			<div class="form-group">
									 <select class="form-control">
									 	<option value="0">Elije el engreido del hogar</option>
	...
	<!--/main-->
		...
		<div class="popup_content newsletter">
            ...
            <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center">
                <figure><img src="/template_2/img/newsletter_img.jpg" alt=""></figure>
            </div>
            <div class="col-md-7">
				<div class="content">
					<div class="wrapper">
					<img src="/template_2/img/logo_black.svg" alt="" width="100" height="35">
...
@section('plugins-js')
<!-- SPECIFIC SCRIPTS -->
	<!--script src="/template_2/js/carousel-home.js"></script-->
	<script src="/template_2/js/subscriptions.js"></script>
