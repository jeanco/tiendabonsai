...
<main>
    ...
    margin-top: 5px;"><span style="font-weight: bold;" >Nota: </span>Puede seleccionar la sucursal que esta más cerca a su ubicación para visualizar el precio sugerido.</div>
	                    ...
	                    <div class="row">
							...
							<div class="btn_add_to_cartx"><a href="#" data-index="{{ $product['id'] }}" class="btn_1 {{ $disabled }}" id="add_item_to_cart_with_number" style="width: 100%; margin: 10px 0 10px 0;">Agregar a la Carretilla</a></div>
	                        </div>
							...
							<div class=""><a   href="/checkout" class="btn_1 {{ $product['stock'] == 0 ? 'disabled' : '' }}"  style="width: 100%; margin: 10px 0 10px 0;">Pagar Ahora</a></div>
	                         ...
	                         <div style="font-size: 11px;background: #d3fed3;   padding: 5px;
    margin: 5px 15px 10px 15px;"><span style="font-weight: bold;" >Nota: </span>Primero debes "Agregar a la Carretilla" antes de decidir pagar por su ladrillo con "Pagar Ahora".</div>
							...
							<div class="tooltip" id="tooltip">
									...
									<div class="info">
										...
										<p class="resumen">Puede Agregar a su Carretilla la cantidad seleccionada y luego puede continuar eligiendo otro producto desde nuestro Catálogo.</p>
										<!--p class="resumen">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <div class="price_box">
							...
							@else
								@if($product['unit_price'])
									<span class="new_price">S/{{ $related_product['unit_price']['price'] }}</span>
								@else
									<span class="new_price">S/{{ $related_product['price'] }}</span>
								@endif
							@endif
	                    </div>
	                    ...
	                    <ul>
							...
							<li><a href="product-detail-2.html#0" data-index="{{ $related_product['id'] }}" data-min="{{ $related_product['minimum_quantity'] }}" class="tooltip-1 add_to_cart {{ $disabled }}" data-toggle="tooltip" data-placement="left" title="Agregar a la carretilla"><!--i class="ti-shopping-cart"></i--><img src="/template_2/img/carretilla_ico.png" width="35px" style="padding: 15px 5px 0px 5px;" ><span>Add to cart</span></a></li>
	                    </ul>
	                </div>
	                <!-- /grid_item -->
				</div>
