<aside class="col-lg-3" id="sidebar_fixed">
	                ...
	                <div class="filter_col">
	                    ...
	                    <div class="filter_type version_2">
	                       <h3 style="font-size: 20px; padding-bottom: 15px;"><a href="#filter_1" data-toggle="collapse" class="opened">Categorías</a></h3>
						...
						<div id="table_category-attribute">
							@include('template_2.catalog.attribute_filter')
						</div>
	                    ...
	                    <div class="buttons">
	                       <a href="/catalogo" class="btn_1 gray">Limpiar filtros</a>
									...
									@if($company_main->vertical_banner_catalog)
	                <div class="banner_menu">
													<a href="">
														<img src="{{ $company_main->vertical_banner_catalog }}" data-src="{{ $company_main->vertical_banner_catalog }}" width="400" height="550" alt="" class="img-fluid lazy loaded" data-was-processed="true">
													</a>
									</div>
									@endif
