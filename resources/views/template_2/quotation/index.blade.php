					...
					<div class="tab-content checkout">
						<div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
								...
								<div class="col-md-12 form-group">
									...
									<div class="custom-select-form">
										<select class="wide add_bottom_15" name="type_recommendation">
											<option value="1" selected>Por la Publicidad en facebook</option>
											<option value="2">Por la Radio</option>
											<option value="3">Por el Periódico</option>
											<option value="4">Por Recomendación</option>
										</select>
									</div>
								</div>
							</div>
							...
							<div class="tooltip" id="tooltip__">
								<div class="thumb">
									<img src="/template_2/img/paso_checkout_quotation.png" alt="">
								</div>
								<div class="info">
...
<script type="text/javascript">
	...
	<script src="/template_2/js/quotations.js"></script>
