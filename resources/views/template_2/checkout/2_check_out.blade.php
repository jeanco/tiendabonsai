...
@section('content')
	...
	<div class="container margin_30">
		...
		@if(!Auth::check())
		<h1>Registra tus datos para realizar {{$company_main->online_payment ? 'la Compra' : 'el Pedido'}}</h1>
		@if (session()->has('data'))
			...
			<div class="row">
					...
					<div class="tab-content checkout">
						<div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
							...
							<div class="form-group">
								...
								<input type="password" name="password" class="form-control" placeholder="Escriba su contraseña de 8 dígitos">
							...
							<div class="form-group" id="pivot_">
								<label class="container_check" id="other_addr">Dirección de Entrega
							...
							<div class="tooltip" id="tooltip_">
								<div class="thumb">
									<img src="/template_2/img/paso_checkout_info.png" alt="">
								</div>
								<div class="info">
									<h4 class="titulo">Destino de Envío</h4>
									<p class="resumen">En caso que la dirección sea otro domicilio, puede modificar en el siguiente formulario.</p>
									<!--p class="resumen">
										La Torre Eiffel es el monumento más famoso de Paris y símbolo de la capital francesa.<br />
									</p>
									<div class="contenedor-btn">
				...
				<div class="col-lg-4 col-md-6">
					<div class="step middle payments">
						...
						<button class="btn_1 full-width pivot_" id="checkout__save">Confirmar {{$company_main->online_payment ? 'la Compra' : 'Pedido'}}</button>
						<div class="tooltip" id="tooltip__">
								<div class="thumb">
									<img src="/template_2/img/paso_checkout_payment.png" alt="">
								</div>
								<div class="info">
									<h4 class="titulo">{{$company_main->online_payment ? 'Compra Segura' : 'Confirme Pedido'}}</h4>
									<p class="resumen">Se procede a realizar {{$company_main->online_payment ? 'la Compra' : 'el Pedido'}} de manera Segura {{$company_main->online_payment ? 'traves de nuestra pasarela de Pagos' : ''}}. En caso de pago efectivo seleccione "Depósito en efectivo" para posterior hacer el pago con su código a los agentes autorizados</p>
									<!--p class="resumen">
										La Torre Eiffel es el monumento más famoso de Paris y símbolo de la capital francesa.<br />
									</p>
									<div class="contenedor-btn">
...
<!-- SPECIFIC CSS -->
    <link href="/template_2/css/checkout.css" rel="stylesheet">
...
<script>
	...
	<script src="/template_2/js/orden_info.js"></script>
