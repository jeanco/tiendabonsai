...
@section('content')
	...
	<main class="bg_gray">
		...
		<div class="page_header">
			<div class="breadcrumbs">
				<ul>
					...
					<li>{{$company_main->icon_car_title}} de compras</li>
				</ul>
			</div>
			<div class="row">
				<div class="col-md-9">
					<!--h1>Carrito de Compras</h1-->
					<h1>{{$company_main->icon_car_title}} de compras</h1>
				</div>

					<div class="col-md-3 form-group" style="{{$company_main->checkout_with_places ? '': 'display:none'}}">
		...
		<table class="table table-striped cart-list">
							...
							<tbody id="cart_tbody">
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_2/img/products/product_placeholder_square_small.jpg" data-src="/template_2/img/products/shoes/1.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_2/img/products/product_placeholder_square_small.jpg" data-src="/template_2/img/products/shoes/2.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="/template_2/img/products/product_placeholder_square_small.jpg" data-src="/template_2/img/products/shoes/3.jpg" class="lazy" alt="Image">
										</div>
						...
						<div class="col-sm-12">
							<div class="apply-coupon">
								<div class="form-group form-inline">
									<a href="/catalogo" id="clean-cart" style="text-decoration: underline;">Limpiar {{$company_main->icon_car_title}}</a>
								</div>
							</div>
						</div>
		...
		<div class="box_cart">
			...
			<a href="/checkout/info" id="pivot" class="btn_1 full-width cart">
				Continuar
				{{$company_main->online_payment ? 'la Compra' : 'Pedido'}}</a>
			<div class="tooltip" id="tooltip">
					<div class="thumb">
						<img src="/template_2/img/paso_checkout.png" alt="">
					</div>
					<div class="info">
						<h4 class="titulo">Continuar {{$company_main->online_payment ? 'la Compra' : 'Pedido'}}</h4>
						<p class="resumen">Click aquí para registrar sus datos y realizar {{$company_main->online_payment ? 'su Compra segura' : 'su pedido'}}.</p>
						<!--p class="resumen">
...
<!-- SPECIFIC CSS -->
    <link href="/template_2/css/cart.css" rel="stylesheet">
...
<script src="/template_2/js/checkout.js"></script>
