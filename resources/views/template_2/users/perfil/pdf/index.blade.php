    ...
    <div class="content-margin" style="margin-top: 50px;">
      <div class="row" style="align-items: center; display: flex; margin-bottom: 40px">
        ...
        <div class="col-6 text-right">
          <div>{{$company_main->social_reason ? $company_main->social_reason : $company_main->name_company}}</div>
          {{--<div>DISTRIBUIDORA MALIBU S.A.C.</div>--}}
          <div>{{ $company_main->address_social_reason ? $company_main->address_social_reason : $company_main->address }}</div>
          {{--<div>Av. San Martín N° 270 - Tacna</div>--}}
      ...
      <div style="padding: 15px 35px;">
        <table width="100%">
          ...
          @else
          <tr>  <td>Dirección de Entrega:</td>               <td>{{ $t['address']  }}</td>
          @endif
