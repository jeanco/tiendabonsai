				...
				<div class="col-lg-9">
					<div class="singlepost">
						...
						<div class="postmeta">
							...
							<li><a href="#"><i class="ti-folder"></i> {{ $blog['tag']['name'] }}</a></li>
								<li><i class="ti-calendar"></i> {{date('d/m/Y', strtotime($blog->date))}}</li>
					...
					<!--div id="comments">
						...
						<ul>
							<li>
								<div class="avatar">
									<a href="blog-post.html#"><img src="/template_2/img/avatar1.jpg" alt="">
									</a>
								</div>
								...
								<ul class="replied-to">
									<li>
										<div class="avatar">
											<a href="blog-post.html#"><img src="/template_2/img/avatar2.jpg" alt="">
											</a>
										</div>
										<div class="comment_right clearfix">
											<div class="comment_info">
							...
							<li>
								<div class="avatar">
									<a href="blog-post.html#"><img src="/template_2/img/avatar3.jpg" alt="">
									</a>
								</div>
					...
					<div class="widget">
						...
						<ul class="comments-list">
							...
							<li>
								...
								<small>{{ $blog['tag']['name'] }} - {{date('d/m/Y', strtotime($blog->date))}}</small>
							...
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_2/img/blog-5.jpg" alt=""></a>
								</div>
							...
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_2/img/blog-6.jpg" alt=""></a>
								</div>
								<small>Category - 11.08.2016</small>
								<h3><a href="blog-post.html#" title="">Verear qualisque ex minimum...</a></h3>
							</li>
							<li>
								<div class="alignleft">
									<a href="blog-post.html#0"><img src="/template_2/img/blog-4.jpg" alt=""></a>
								</div>
								<small>Category - 11.08.2016</small>
								<h3><a href="blog-post.html#" title="">Verear qualisque ex minimum...</a></h3>
							</li>
...
<!-- SPECIFIC CSS -->
    <link href="/template_2/css/blog.css" rel="stylesheet">
