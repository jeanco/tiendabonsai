...
class PostController extends Controller {
	...
	public function show_view() {
        ...
        return view('template_7.blog.index', compact('tags', 'blogs', 'last_blogs'));
	}
	...
	public function show_profile($slug) {
        ...
        $tags = DB::table('tags_posts')
            ...
            return view('template_7.blog.perfil.index', compact('blog', 'last_blogs', 'tags'));
    }
	...
	public function fetch_data_blogs(Request $request) {
		...
		if ($request->ajax()) {
            ...
            return view("template_7.blog.list_blogs", compact('blogs'))->render();
		}
