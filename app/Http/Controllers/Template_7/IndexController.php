...
class IndexController extends Controller {
	...
	public function main_view() {
		...
		*/
		...
		return view('template_7.home.index', compact('banners', 'categories', /*'simple_banner'*/'promoted_products', 'featured_products', 'categories_featured', 'catalogs', 'sliders_quantity'));
	}
	...
	public function get_view_catalog($etiquette_slug = null) {
		...
		return view('template_7.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes', 'etiquette_id', 'etiquette_flag'));
	...
	public function get_view_about_us() {
		...
		*/
		...
		return view("template_7.we.index", compact('company', 'last_autos_array', 'services', 'gallery_company'));
	}
	...
	public function get_view_catalog_etiquette($etiquette_slug){
		...
		if (!count($etiquette)) {
			return view('template_7.catalog.etiquette_not_found');
		}
