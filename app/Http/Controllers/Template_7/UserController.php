...
use App\Http\Requests\RegisterUserTemplate7Request;
...
class UserController extends Controller {
	...
	public function show_view(Request $request) {
		return view("template_7.users.register.index");
	}
	...
	public function show_my_profile_view() {
		...
		// 	);
		// }
		return view('template_7.users.perfil.index', compact('customer', 'countries', 'user_orders', 'user_cupons', 'user_id'));
	}
