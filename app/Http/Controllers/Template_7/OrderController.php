...
use App\Http\Requests\StoreOrderTemplate7Request;
...
class OrderController extends Controller {
	...
	public function store(StoreOrderTemplate7Request $request) {
	...
	public function show($id) {
		...
		return view('template_7.users.perfil.pdf.index', compact('t'));
