...
namespace App\Http\Controllers\Template_5;
...
class CheckoutController extends Controller {
	...
	public function get_view() {
		return view('template_5.checkout.1_shopping_cart');
	}
	...
	public function order_info() {
		...
		return view('template_5.checkout.2_check_out', compact('address', 'accounts', 'first_name', 'last_name', 'cel_whatsapp', 'countries', 'first_name_two', 'last_name_two', 'identity_document_two', 'cel_whatsapp_two', 'address_two', 'identity_document', 'country_id', 'province_id', 'city_id', 'district_id', 'birthday','shipping_policies', 'formToken'));
	}
	...
	public function complete(Request $request) {
		...
		if (!count($order_history)) {
			return view('template_5.checkout.4_order_not_found');
		}
		...
		$order = Order::with('customer')->with(['account' => function ($query) {
		...
		return view('template_5.checkout.3_order_complete', compact('charge', 'total','order_detail','order'));
	}
