...
class PostController extends Controller {
	...
	public function show_view() {
		...
		return view('template_5.blog.index', compact('tags', 'blogs', 'last_blogs'));
	}
	...
	public function show_profile($slug) {
		...
		return view('template_5.blog.perfil.index', compact('blog', 'last_blogs', 'tags'));
	}
	...
	public function fetch_data_blogs(Request $request) {
		...
		if ($request->ajax()) {
			...
			return view("template_5.blog.list_blogs", compact('blogs'))->render();
		}
