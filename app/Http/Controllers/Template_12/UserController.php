...
use App\Http\Requests\RegisterUserTemplate12Request;
...
class UserController extends Controller {
	...
	public function register(RegisterUserTemplate7Request $request) {
		...
		return response()->json(['title' => 'Operación Exitosa', 'message' => 'Se ha registrado el usuario' , 'id_user' => $user->id ], 200);

	}

	public function show_view(Request $request) {
		return view("template_12.users.register.index");
	}
	...
	public function show_my_profile_view() {
		...
		// 	);
		// }
		return view('template_12.users.perfil.index', compact('customer', 'countries', 'user_orders', 'user_cupons', 'user_id'));
	}

	public function update_my_profile($customer_id, ProfileUpdateRequest $request) {
