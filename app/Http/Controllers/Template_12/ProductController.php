...
class ProductController extends Controller {
	...
	public function get_view($slug, Request $request) {
		...
		return view('template_12.catalog.perfil.index', compact('product', 'related_products', 'brand', 'colors', 'sizes', 'product_presentation', 'main_photo', 'other_photos'));
	}
	...
	public function fetch_data(Request $request) {
		...
		if ($request->ajax()) {
			...
			return view("template_12.catalog.3_right_catalog", compact('products', 'etiquette_flag'))->render();
		}
	}
