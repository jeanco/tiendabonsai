...
class IndexController extends Controller {
	...
	public function main_view() {
		...
		*/
		...
		$catalogs = Catalog::wherePublished(1)
		 ...
		 $catalog_rows = ceil(count($catalogs)/2);
       	...
       	return view('template_12.home.index', compact('banners', 'categories', /*'simple_banner'*/'promoted_products', 'featured_products', 'categories_featured', 'catalogs', 'sliders_quantity','catalog_rows'));
	}
	 ...
	 public function get_view_construction() {
        ...
        return view('template_12.construction.index', compact('company'));
    }
	...
	public function get_view_catalog($etiquette_slug = null) {
		...
		return view('template_12.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes', 'etiquette_id', 'etiquette_flag'));
	...
	public function get_view_about_us() {
		...
		*/
		...
		return view("template_12.we.index", compact('company', 'last_autos_array', 'services', 'gallery_company'));
	}
	...
	public function get_view_catalog_etiquette($etiquette_slug){
		...
		if (!count($etiquette)) {
			return view('template_12.catalog.etiquette_not_found');
		}

		// $subcategories_id = DB::table('etiquette_product')
		// 	->where('etiquette_id', $etiquette->id)
		...
		// 		$query->whereIn('id', $subcategories_id);
		// 	})
		// 	->select(['id', 'name', 'icon', 'icon_white', 'slug'])
		// 	->with(['subcategories' => function ($query) use ($subcategories_id) {
		// 		$query->whereIn('id', $subcategories_id);
		// 		$query->select(['id', 'category_id', 'name', 'slug']);
		// 		$query->wherePublished(1);
		// 	}])
