...
class IndexController extends Controller {
	...
	public function main_view() {
		...
		*/
		...
		// })
			->with(['products' => function ($query) {
				$query->wherePublished(1)
					...
					->with('main_photo')
					->with('other_photo')
					->select(['id', 'category_id', 'promotion_available', 'slug', 'promotion_end_at', 'promotion_label_image', 'stock', 'name', 'price', 'price_promotion', 'promotion_discount', 'transfer_available', 'transfer_price', 'transfer_end_at']);
			}])->get();
		...
		return view('template_14.home.index', compact('banners', 'categories', /*'simple_banner'*/'promoted_products', 'featured_products', 'categories_featured', 'catalogs', 'sliders_quantity'));
	}
	...
	public function get_view_construction() {
        ...
        return view('template_14.construction.index', compact('company'));
    }
	...
	public function get_view_catalog() {
		...
		return view('template_14.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes'));
	...
	public function get_view_about_us() {
		...
		*/
		...
		return view("template_14.we.index", compact('company', 'last_autos_array', 'services', 'gallery_company'));
	}
