...
use App\Http\Requests\StoreOrderTemplate1_v1Request;
...
public function show($id) {
		...
		foreach ($order_products as $l => $order_product) {
			...
			$p[] = array(
				...
				'discount' => (float) $order_product->discount - $order_product->price,
		...
		return view('template_13.users.perfil.pdf.index', compact('t'));
		//return view('template_3.users.perfil.pdf.index', compact('t'));

	}

	public function store(StoreOrderTemplate1_v1Request $request) {
