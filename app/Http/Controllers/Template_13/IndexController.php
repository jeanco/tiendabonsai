...
class IndexController extends Controller {
   ...
   //          ->get();
        ...
        return view('template_13.home.index', compact('banners', 'categories','categories_featured', 'place_id_selected', 'promoted_products', 'featured_products', 'catalogs', 'catalog_rows'));
    }
    ...
    public function get_view_construction() {
        ...
        return view('template_13.construction.index', compact('company'));
    }
    ...
    public function get_view_catalog(Request $request){
        ...
        return view('template_13.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes', 'place_id_selected', 'etiquette_id'));
    ...
    public function get_view_about_us(){
       ...
       /* $video = Content::whereModel_type(1)->where('type', '=', 2)->where('deleted_at', '=', null)->get();
		...
		return view("template_13.we.index", compact('company', 'last_autos_array', 'services','gallery_company'));
    }
    ...
    public function get_view_catalog_etiquette($etiquette_slug){
        ...
        if (!count($etiquette)) {
            return view('template_13.catalog.etiquette_not_found');
        }
        ...
        $etiquette_flag = true;
        return view('template_13.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes', 'etiquette_id'));
