...
class IndexController extends Controller {
    ...
    public function main_view(Request $request){
        ...
        return view('template_9.home.index', compact('banners', 'categories',/*'simple_banner'*/ 'promoted_products', 'featured_products','categories_featured', 'place_id_selected'));
    }
    ...
    public function get_view_catalog(Request $request){
        ...
        return view('template_9.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes', 'place_id_selected'));
    ...
    public function get_view_about_us(){
       ...
       /* $video = Content::whereModel_type(1)->where('type', '=', 2)->where('deleted_at', '=', null)->get();
		...
		return view("template_9.we.index", compact('company', 'last_autos_array', 'services','gallery_company'));
    }
