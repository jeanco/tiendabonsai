...
class IndexController extends Controller {
    ...
    public function main_view(){
        ...
        return view('template_2.home.index', compact('banners', 'categories',/*'simple_banner'*/ 'promoted_products', 'featured_products'));
    }
    ...
    public function get_view_construction() {
        ...
        return view('template_10.construction.index', compact('company'));
    }
    ...
    public function get_view_catalog(){
       ...
       /* $simple_banner = Campaign::wherePublished(1)->where('')
            ->first();*/
        $simple_banner = Campaign::where('published', 1)
        ...
        return view('template_2.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes'));
    ...
    public function get_view_about_us(){
       ...
       /* $video = Content::whereModel_type(1)->where('type', '=', 2)->where('deleted_at', '=', null)->get();
		...
		return view("template_2.we.index", compact('company', 'last_autos_array', 'services','gallery_company'));
    }

    public function get_normativa(){
       ...
       /* $video = Content::whereModel_type(1)->where('type', '=', 2)->where('deleted_at', '=', null)->get();
        ...
        return view("template_2.normativa.index", compact('company', 'last_autos_array', 'services','gallery_company'));
    }
    ...
    public function get_cita(){
       ...
       /* $video = Content::whereModel_type(1)->where('type', '=', 2)->where('deleted_at', '=', null)->get();
        ...
        return view("template_2.cita.index", compact('company', 'last_autos_array', 'services','gallery_company'));
    }
