...
use App\Http\Requests\RegisterUserMirandaRequest;
use App\Order;
use App\Role;
...
class UserController extends Controller {
	...
	public function register(RegisterUserMirandaRequest $request) {
		/*$data = $request->all();
			$identity_document = $data['dni'];
			...
			if (count($exist_customer)) {
				...
				$exist_customer->identity_document = $data['dni'];
				...
				$new_customer->identity_document = $data['dni'];
		...
		*/
		...
		$empresa_nombre = $data['first_name'] . ' ' . $data['last_name'];

		$data['name_company'] = $empresa_nombre;
		$data['business_company'] = $empresa_nombre;
		$data['ruc'] = $data['dni'];
		$data['membership_date'] = $now_date;
		$data['representative'] = '';
		$data['title_slogan'] = '';
		$data['subtitle_slogan'] = '';
		$data['representative'] = '';
		$data['slug_company'] = str_slug($empresa_nombre);
