...
class IndexController extends Controller {
	...
	public function main_view() {
		...
		*/
		...
		$sliders_quantity = (int) ceil(count($promoted_products) / 3);
		...
		return view('template_4.home.index', compact('banners', 'categories', /*'simple_banner'*/'promoted_products', 'featured_products', 'categories_featured', 'catalogs', 'sliders_quantity'));
	}
	...
	public function get_view_catalog() {
		...
		return view('template_4.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes'));
	...
	public function get_view_about_us() {
		...
		*/
		...
		return view("template_4.we.index", compact('company', 'last_autos_array', 'services', 'gallery_company'));
	}
	...
	public function get_view_construction() {
		...
		return view('template_4.construction.index', compact('company'));
	}
