...
use App\Http\Requests\ProfileUpdateTemplate4Request;
...
class UserController extends Controller {
	...
	public function show_view(Request $request) {
		return view("template_4.users.register.index");
	}
	...
	public function show_my_profile_view() {
		...
		// 	);
		// }
		return view('template_4.users.perfil.index', compact('customer', 'countries', 'user_orders', 'user_cupons', 'user_id'));
	}

	public function update_my_profile($customer_id, ProfileUpdateTemplate4Request $request) {
