...
class IndexController extends Controller {
	...
	public function main_view() {
		...
		*/
		...
		return view('template_3.home.index', compact('banners', 'categories', /*'simple_banner'*/'promoted_products', 'featured_products', 'categories_featured', 'catalogs', 'sliders_quantity'));
	}
	...
	public function get_view_construction() {
        ...
        return view('template_3.construction.index', compact('company'));
    }
	...
	public function get_view_catalog() {
		...
		return view('template_3.catalog.index', compact('products', 'simple_banner', 'categories', 'category_attributes'));
	...
	public function get_view_about_us() {
		...
		*/
		...
		return view("template_3.we.index", compact('company', 'last_autos_array', 'services', 'gallery_company'));
	}
