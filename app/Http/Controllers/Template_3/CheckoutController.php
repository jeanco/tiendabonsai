...
class CheckoutController extends Controller {
	...
	public function get_view() {
		return view('template_3.checkout.1_shopping_cart');
	}
	...
	public function order_info() {
		...
		return view('template_3.checkout.2_check_out', compact('address', 'first_name', 'last_name', 'cel_whatsapp', 'countries', 'first_name_two', 'last_name_two', 'identity_document_two', 'cel_whatsapp_two', 'address_two', 'identity_document', 'country_id', 'province_id', 'city_id', 'district_id', 'birthday', 'payment_ways'));
	}
	...
	public function complete(Request $request) {
		...
		return view('template_3.checkout.3_order_complete', compact('charge', 'total'));
	}
