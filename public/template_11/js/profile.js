(() => {
	...
	if (getElement(`#profile_country`).value != null) {
		axios.get(`/api/template_11/country/${getElement(`#profile_country`).value}/cities`)
			.then((response) => {
		...
		.then(() => {
			axios.get(`/api/template_11/province/${getElement(`#profile_province-id`).value}/districts`)
			.then((response) => {
		...
		// .then(() => {
		// 	axios.get(`/api/template_11/district/${getElement(`#district_id`).value}/shipping-cost`)
		// 		.then((response) => {
