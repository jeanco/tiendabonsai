jQuery(document).ready(function($) {
   ...
   $(document).on("mouseup", function(e) {
    ...
    $(".filter-cate-color ul li").on("click", function() {
        $('li.active').removeClass('active');
        $(this).addClass('active');
    });
    ...
    if ($('.price-slider').length > 0) {
        $('.price-slider').slider({
            min: parseInt(getElement('#min_price_').value),
            max: parseInt(getElement('#max_price_').value),
            step: 10,
            value: [parseInt(getElement('#min_price_').value), parseInt(getElement('#max_price_').value)],
        });
    }
