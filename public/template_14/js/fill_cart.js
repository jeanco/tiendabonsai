                ...
                _content += 
                    `<li>
                        <a href="/catalogo/${product.slug}">
                            ...
                            <strong><span>${product.name}</span>S/ ${product.price} ${product.transfer_available ? `<br><span style="font-size: 12px;line-height: 9px;">Exclusivo con Transferencia</span><span style="background: yellow;line-height: 22px;">S/ ${product.transfer_price} </span>` : ``}</strong>
                        </a>
