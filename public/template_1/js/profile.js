(() => {
	...
	if (getElement(`#profile_country`).value != null) {
		axios.get(`/api/template_1/country/${getElement(`#profile_country`).value}/cities`)
			.then((response) => {
		...
		.then(() => {
			axios.get(`/api/template_1/province/${getElement(`#profile_province-id`).value}/districts`)
			.then((response) => {
		...
		// .then(() => {
		// 	axios.get(`/api/template_1/district/${getElement(`#district_id`).value}/shipping-cost`)
		// 		.then((response) => {
