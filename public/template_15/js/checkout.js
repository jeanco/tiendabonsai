(() => {
                ...
                _content +=
                        ...
                        `
                            <tr>
                                ...
                                <td class="options">
                                    <button href="" data-index="${product.id}" style="background: #ff4444; color: white;" class="action cart__remove-product"><i class="ti-trash"></i></button>
    ...
    $(`#apply_coupon`)
        .on('click', function(){
            ...
            axios.get(`/api/template_15/coupon/${_code}/information?ids=${localStorage.getItem("cart")}`)
                .then((response) => {
                    Swal.fire(
                    '',
