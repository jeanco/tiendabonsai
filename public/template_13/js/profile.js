(() => {
	...
	if (getElement(`#profile_country`).value != null) {
		axios.get(`/api/template_13/country/${getElement(`#profile_country`).value}/cities`)
			.then((response) => {
		...
		.then(() => {
			axios.get(`/api/template_13/province/${getElement(`#profile_province-id`).value}/districts`)
			.then((response) => {
	...
	// 		axios.get(`/api/template_3/country/${getElement(`#profile_country`).value}/cities`)
	// 			.then((risposta) => {
